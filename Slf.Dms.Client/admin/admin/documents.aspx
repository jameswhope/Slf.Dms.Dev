<%@ Page Language="VB" MasterPageFile="~/admin/settings/settings_documents.master" AutoEventWireup="false" CodeFile="documents.aspx.vb" Inherits="admin_documents" title="DMP - Documents" %>
...
<asp:Content ID="cphBody" ContentPlaceHolderID="cphBody" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        {
            window.location.href = '<%=ResolveUrl("~/admin/singledocument.aspx") %>?a=e&id=' + id;
        }
        
        function AddDocument()
        {
            window.location.href = '<%=ResolveUrl("~/admin/singledocument.aspx") %>?a=a';
        }
