<%@ Page Language="VB" MasterPageFile="~/admin/Admin.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="admin_ClientStatements_Default" Title="Client Statement Processing"%>
            ...
            <tr>
                <td valign="top" style="width:75%;">
                    <table style="table-layout:fixed;font-family:tahoma;font-size:11px;width:100%;" cellpadding="5" cellspacing="0" border="0">
                        <tr>
<%--                            <td><a runat="server" id="lnkSimple">S</a>ingle Statement&nbsp;&nbsp;|&nbsp;&nbsp;<a runat="server" id="lnkAdvanced" Visible="false">S</a>tatements 
                                for the Period</td>--%>
                        </tr>
                        <tr>
                            <td>
                                        ...
                                        Statement(s) for the period
                                            ...
                                            <tr>
                                                <td style="width: 112px">
                                                    <asp:Label runat="server" text="Account # for statement:" Width="130px" Visible="false"></asp:Label>
                                                </td>
                                                <td align="left" style="width: 221px">
                                                    <asp:TextBox ID="txtAccountNumber" runat="server" CssClass="entry" Width="100px" Enabled="false" Visible="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 112px">
                                                    <asp:label Text="Start Date:" Width="80" runat="server" Visible="false"></asp:label>
                                                    <asp:TextBox ID="txtStartDate" runat="server" CssClass="entry" Width="100px" Enabled="false" Visible="false"></asp:TextBox>
                                                </td>
                                                <td style="width: 112px">
                                                    <asp:label Text="End Date:" runat="server" Width="80" Visible="false"></asp:label>
                                                    <asp:TextBox ID="txtEndDate" runat="server" CssClass="entry" Width="100px" Enabled="false" Visible="false"></asp:TextBox>
                                                </td>
                                                <td style="padding-left:5;width:80;">
                                                    <asp:label Text="Create Statements: " runat="server" Width="80" Visible="false"></asp:label>
                                                    <asp:LinkButton ID="lnkCreateStatements" runat="server"  Enabled="false" Visible="false"><img id="Img4" 
                                            ...
                                            <tr>
                                                <td style="padding-left:5;width:80;">
                                                    ...
                                                    <asp:TextBox ID="txtNumToPrint" runat="server" CssClass="entry" Width="50px"></asp:TextBox>
                                                </td>
                                                <td style="padding-left:5;width:80;">
                                            ...
                                            border="0" />
                                                ...
                                                <td>
                                                    <asp:Label ID="lblInQueue" runat="server" Width = "50px" text="In Queue:"></asp:Label>
                                                    <asp:TextBox ID="txtInQueue" runat="server" ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                  </table>
                                    </table>
