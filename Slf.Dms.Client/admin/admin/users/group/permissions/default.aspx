<%@ Page Language="VB" MasterPageFile="~/admin/users/group/group.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="admin_users_group_permissions_default" title="DMP - Admin - Groups" %>
...
function Record_ClearPermissionsConfirm()
{
    ...
    var url = '<%= ResolveUrl("~/util/pop/confirm.aspx")%>?f=Record_ClearPermissions&t=Clear All Permissions&m=Are you sure you want to clear all permissions for this group?';
...
function ToggleChildren(img)
{
    ...
    else
    {
        ...
        // send request
	    xml.load("<%= ResolveUrl("~/util/getchildfunctions_group.ashx?fid=") %>" + row.functionid + "&UserGroupId=<%=UserGroupId %>&definedonly=<%=chkDefinedOnly.Checked.ToString()%>");
    }
}
function nz(obj)
{
...
<table style="width:100%;font-family:tahoma;font-size:11px;" cellspacing="15" cellpadding="0" border="0">
    <tr>
        <td style="color: #666666;"><a runat="server" class="lnk" style="color: #666666;" href="~/admin/users">User Groups</a>&nbsp;>&nbsp;<a id="lnkUser" runat="server" style="color: #666666;" class="lnk"></a>&nbsp;>&nbsp;Permissions</td>
    </tr>
    <tr>
        <td>
            <div class="iboxDiv">
        ...
        <td>
            <table style="background-color:#f1f1f1;font-family:tahoma;font-size:11px;width:100%;" cellpadding="5" cellspacing="0" border="0">
                <tr>
                    ...
                    <td width="100%"></td>
                    <td nowrap align="right"><a class="lnk" id="lnkClearPermissionsConfirm" runat="server" href="javascript:Record_ClearPermissionsConfirm();">Clear Permissions</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a runat="server" href="javascript:window.print();"><img runat="server" src="~/images/16x16_print.png" border="0" align="absmiddle"/></a></td>
                </tr>
            </table>
            ...
            <asp:panel runat="server" id="pnlNone" style="text-align:center;color:#a1a1a1;padding: 5 5 5 5;">This group has no defined permissions</asp:panel>
            <br />
