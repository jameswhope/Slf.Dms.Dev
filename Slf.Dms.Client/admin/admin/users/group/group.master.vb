...
Partial Class admin_users_group_group
...
#End Region
        ...
        Else
            ...
            For i As Integer = 0 To tabTableCells.Count - 1
                ...
                Else
                    ...
                    tabTables(i).Attributes("onclick") = "javascript:window.navigate(""" & ResolveUrl("~/admin/users/group/" _
    ...
    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        AddControl(pnlBody, c, "Admin-Users-Group Single Record")
        AddControl(trTabGeneralInfo, c, "Admin-Users-Group Single Record-General Information")
        AddControl(trTabPermissions, c, "Admin-Users-Group Single Record-Permissions")
    End Sub
End Class