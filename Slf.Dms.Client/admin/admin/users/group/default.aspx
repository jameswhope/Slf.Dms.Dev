<%@ Page Language="VB" MasterPageFile="~/admin/users/group/group.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="admin_users_group_default" title="DMP - Admin - Users" %>
...
<body id="bodMain" runat="server">
	...
	{
             var url = '<%= ResolveUrl("~/delete.aspx?t=Group&p=group") %>';
    ...
    <table style="font-family:tahoma;font-size:11px;width:100%;height:100%;" border="0" cellpadding="0" cellspacing="15">
        <tr><td style="color: #666666;"><a runat="server" class="lnk" style="color: #666666;" href="~/admin/users">User Groups</a>&nbsp;>&nbsp;<asp:Label id="lblUser" runat="server" style="color: #666666;"></asp:Label></td></tr>
        <tr>
