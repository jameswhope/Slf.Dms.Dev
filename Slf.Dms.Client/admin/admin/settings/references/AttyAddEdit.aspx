                    ...
                    <td valign="top" style="padding: 0 15 0 15">
                        <table id="tblAttorneys" runat="server" style="table-layout: fixed; width: 100%;
                            ...
                            <tr>
                                ...
                                <td class="headItem" style="width: 150; padding: 0 0 2 5" valign="top">
                                    <asp:TextBox ID="txtEmailAddress" runat="server" CssClass="entry" MaxLength="30" ></asp:TextBox></td>
                                <td class="headItem" style="padding: 0 0 2 5" valign="top">
                                    <asp:HiddenField ID="hdnUserID" runat="server" Value="-1" />
                                    <asp:TextBox ID="txtEmailAddress2" runat="server" CssClass="entry" MaxLength="30" ></asp:TextBox></td>
                                <td class="headItem" style="padding: 0 0 2 5" valign="top">
                                    <asp:TextBox ID="txtEmailAddress3" runat="server" CssClass="entry" MaxLength="30" ></asp:TextBox></td>
                            </tr>
                        </table>
                    </td>
                </tr>
