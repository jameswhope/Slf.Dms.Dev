...
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        {
            showModalDialog("<%= ResolveUrl("~/util/pop/confirmholder.aspx") %>?f=CallRemoveAttorney&t=Remove Attorney&m=Are you sure you want to remove this attorney? Doing so will remove all settlement attorney associations, state licenses, and state primary assigments.", window, "status:off;help:off;dialogWidth:325px;dialogHeight:175px;");
        }
                        ...
                        <table id="tblAttorneys" runat="server" style="table-layout: fixed; width: 100%;
                            ...
                            <tr>
                                ...
                                <td class="headItem" style="padding: 0 0 2 5" valign="top">
                                    <asp:HiddenField ID="hdnUserID" runat="server" Value="-1" /> &nbsp;</td>
                                <td class="headItem" style="padding: 0 0 2 5" valign="top">
                                    &nbsp;</td>
                            </tr>
                        </table>
