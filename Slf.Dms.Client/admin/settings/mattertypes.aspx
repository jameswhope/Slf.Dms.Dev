<%@ Page Language="VB" MasterPageFile="~/admin/settings/settings.master" AutoEventWireup="false" CodeFile="mattertypes.aspx.vb" Inherits="admin_settings_mattertypes" title="DMP - Matter Types" %>
...
<asp:Content ID="cphBody" ContentPlaceHolderID="cphBody" Runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        {
            window.location.href = '<%=ResolveUrl("~/admin/settings/singlemattertype.aspx") %>?a=e&id=' + id;
        }
        
        function AddMatterType()
        {
            window.location.href = '<%=ResolveUrl("~/admin/settings/singlemattertype.aspx") %>?a=a';
        }
            ...
            <td>
                    ...
                    <tr>
                        <td style="background-color:#f3f3f3;padding: 5 5 5 5;">
                            <table style="font-family:tahoma;font-size:11px;width:100%;" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="color:rgb(50,112,163);">Matter Types</td>
                ...
                <table class="trefTable" onmouseover="RowHover(this,true)" onmouseout="RowHover(this,false)" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td id="tdHeader_MatterTypeCode" class="trefHeaderCell" style="width:150px;cursor:pointer;" align="left" onclick="Sort(this);">Matter Type<img id="imgSort_MatterTypeCode" border="0" style="margin-left:5px;" align="absmiddle" alt="" /></td>
                        <td id="tdHeader_MatterTypeShortDescr" class="trefHeaderCell" style="cursor:pointer;" align="left" onclick="Sort(this);">Matter Type Desc<img id="imgSort_MatterTypeShortDescr" border="0" style="margin-left:5px;" align="absmiddle" alt="" /></td>
                        <td id="tdHeader_MatterGroup" class="trefHeaderCell" style="cursor:pointer;" align="left" onclick="Sort(this);">Matter Group<img id="imgSort_MatterGroup" border="0" style="margin-left:5px;" align="absmiddle" alt="" /></td>
                        <td id="tdHeader_IsActive" class="trefHeaderCell" style="width:150px;cursor:pointer;" align="left" onclick="Sort(this);">Is Active<img id="imgSort_IsActive" border="0" style="margin-left:5px;" align="absmiddle" alt="" /></td>
                            ...
                            <itemtemplate>
                                    <tr>
                                        <td style="width:20px;" class="trefBodyCell" align="center">
                                            <img onmouseup="this.style.display='none';this.nextSibling.style.display='inline';this.nextSibling.nextSibling.checked=true;window.event.cancelBubble=true;return false;" src="<%=ResolveUrl("~/images/13x13_check_cold.png") %>" border="0" align="absmiddle" /><img onmouseup="this.style.display='none';this.previousSibling.style.display='inline';this.nextSibling.checked=false;window.event.cancelBubble=true;return false;" style="display:none;" src="<%=ResolveUrl("~/images/13x13_check_hot.png") %>" border="0" align="absmiddle" /><input onpropertychange="AddOrDrop(this, <%#CType(Container.DataItem, MatterType).MatterTypeID %>);" style="display:none;" type="checkbox" />
                                        </td>
                                        <a href="#" onclick="RowClick(<%#CType(Container.DataItem, MatterType).MatterTypeId %>);">
                                            ...
                                            <td nowrap align="left" style="width:150px;">
                                                <%#CType(Container.DataItem, MatterType).MatterTypeCode%>
                                            </td>
                                            <td nowrap align="left">
                                                <%#CType(Container.DataItem, MatterType).MatterTypeShortDescr%>
                                            </td>
                                            <td nowrap align="left" style="width:150px;">
                                                <%#CType(Container.DataItem, MatterType).MatterGroup%>&nbsp;
                                            </td>
                                            <td nowrap align="left" style="width:150px;">
                                                <%#CType(Container.DataItem, MatterType).IsActive%>
                                            </td>
