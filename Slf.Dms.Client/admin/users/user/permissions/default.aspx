<%@ Page Language="VB" MasterPageFile="~/admin/users/user/user.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="admin_users_user_permissions_default" title="DMP - Admin - Users" %>
...
function ToggleChildren(img)
{
    ...
    else
    {
        ...
        // send request
	    xml.load("<%= ResolveUrl("~/util/getchildfunctions.ashx?fid=") %>" + row.functionid + "&UserId=<%=RecordUserId %>&definedonly=<%=chkDefinedOnly.Checked.ToString()%>");
    }
}
function nz(obj)
{
...
<table style="width:100%;font-family:tahoma;font-size:11px;" cellspacing="15" cellpadding="0" border="0">
    <tr>
        <td style="color: #666666;"><a runat="server" class="lnk" style="color: #666666;" href="~/admin/users">Users</a>&nbsp;>&nbsp;<a id="lnkUser" runat="server" style="color: #666666;" class="lnk"></a>&nbsp;>&nbsp;Permissions</td>
    </tr>
    <tr>
        <td>
            <div class="iboxDiv">
    ...
    <tr>
        <td>
            ...
            <asp:panel runat="server" id="pnlNone" style="text-align:center;color:#a1a1a1;padding: 5 5 5 5;">This user has no defined permissions</asp:panel>
            <br />
