...
Partial Class admin_users_user_user
...
#End Region
    ...
    Private Sub SetTabAndRollup()
        ...
        tabTableRows.Add(trTabTalents)
        tabTableRows.Add(trTabHistory)

        tabTableCells.Add(tdTabGeneralInfo)
        tabTableCells.Add(tdTabPermissions)
        tabTableCells.Add(tdTabTalents)
        tabTableCells.Add(tdTabHistory)

        tabTables.Add(tblTabGeneralInfo)
        tabTables.Add(tblTabPermissions)
        tabTables.Add(tblTabTalents)
        tabTables.Add(tblTabHistory)

        tabImages.Add(imgTabGeneralInfo)
        tabImages.Add(imgTabPermissions)
        tabImages.Add(imgTabTalents)
        tabImages.Add(imgTabHistory)
        ...
        Else
            ...
            For i As Integer = 0 To tabTableCells.Count - 1
                ...
                Else
                    ...
                    tabTables(i).Attributes("onclick") = "javascript:window.navigate(""" & ResolveUrl("~/admin/users/user/" _
    ...
    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        AddControl(pnlBody, c, "Users-User Single Record")
        If Not _addmode Then
            AddControl(trTabGeneralInfo, c, "Users-User Single Record-General Information")
            AddControl(trTabHistory, c, "Users-User Single Record-History")
            AddControl(trTabPermissions, c, "Users-User Single Record-Permissions")
            AddControl(trTabTalents, c, "Users-User Single Record-Talents")
        End If
    End Sub
End Class