...
Partial Class admin_users_usertype_members_default
...
#End Region
    ...
    Private Sub Requery()
        ...
        DatabaseHelper.AddParameter(cmd, "where", "tbluser.usertypeid=" & UserTypeId)
    ...
    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        AddControl(pnlBody, c, "Admin-Users-User Type Single Record-Members")
    End Sub
