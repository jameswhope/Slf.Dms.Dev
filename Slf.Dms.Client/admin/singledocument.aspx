<%@ Page Language="VB" MasterPageFile="~/admin/settings/settings_documents.master" AutoEventWireup="false" CodeFile="singledocument.aspx.vb" Inherits="admin_singledocument" title="DMP - Admin Settings - References" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" Runat="Server">
	...
	function Save()
    {
        ...
        if (docNameIdx >= 0 && action == 'a')
        {
            ...
            ShowMessage('That <a class="lnk" href="~/admin/singledocument.aspx?a=e&id=' + docID + '" runat="server">Document Name</a> already exists, please choose another one.');
            return;
        }
