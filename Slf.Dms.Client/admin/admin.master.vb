...
Partial Class admin_admin
    ...
    Private Sub A6_ServerClick(sender As Object, e As EventArgs) Handles A6.ServerClick
        Diagnostics.Process.Start("chrome.exe", "https://lexxware.com/commissionBreakdown.aspx")
    End Sub
End Class