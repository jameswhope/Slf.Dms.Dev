<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="DraftAnalysis.aspx.vb" Inherits="Clients_Enrollment_DraftAnalysis" %>
            ...
            <div class="portlet">
                   <div class="portlet-content">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LawFirm" HeaderText="Law Firm" HtmlEncode="false">
                            ...
                            <asp:BoundField DataField="Rep" HeaderText="Sales Agent" HtmlEncode="false">
                            ...
                            <asp:BoundField DataField="Start Date" HeaderText="Start Date" dataformatstring="{0:MM/dd/yyyy}">
                            ...
                            <asp:BoundField DataField="Draft Amount" HeaderText="Draft Amount" dataformatstring="{0:c}">
                            ...
                            <asp:BoundField DataField="NSF" HeaderText="NSF" >
                                <HeaderStyle HorizontalAlign="center" CssClass="headItem5" Width="80px"/>
                                <ItemStyle HorizontalAlign="center" CssClass="griditem" Width="80px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="6 Month NSF" HeaderText="6 Month NSF" >
                                <HeaderStyle HorizontalAlign="center" CssClass="headItem5" Width="80px"/>
                                <ItemStyle HorizontalAlign="center" CssClass="griditem" Width="80px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="12 Month NSF" HeaderText="12 Month NSF" >
                                <HeaderStyle HorizontalAlign="center" CssClass="headItem5" Width="80px"/>
                                <ItemStyle HorizontalAlign="center" CssClass="griditem" Width="80px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="Last NSF Date" HeaderText="Last NSF Date" dataformatstring="{0:MM/dd/yyyy}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headitem5" Width="80px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem" Width="80px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="Skipped Drafts Last 6 Months" HeaderText="Skipped Drafts Last 6 Months" >
                                <HeaderStyle HorizontalAlign="center" CssClass="headItem5" Width="150px"/>
                                <ItemStyle HorizontalAlign="center" CssClass="griditem" Width="150px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>                         
                        </Columns>
                    </asp:GridView>
