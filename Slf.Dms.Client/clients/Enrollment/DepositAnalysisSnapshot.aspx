<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="DepositAnalysisSnapshot.aspx.vb" Inherits="Clients_Enrollment_DepositAnalysisSnapshot" %>
     ...
     <asp:UpdatePanel ID="upPage" runat="server">
        <ContentTemplate>
            <div style="float: left; margin: 5 0 0 5; color: #808080;">
                <h4>Deposit Analysis Snapshot</h4>
            </div>
