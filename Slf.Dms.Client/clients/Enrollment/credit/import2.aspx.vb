...
Partial Class Clients_Enrollment_credit_import
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Dim creditreportid As String = CredStarHelper2.GetCreditReportId(Request.QueryString("reportid"))

            Dim html As String = CredStarHelper2.ShowCreditReport(Request.QueryString("reportid"))
