<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="NewEnrollment4.aspx.vb" Inherits="Clients_Enrollment_NewEnrollment4" %>
...
<%@ Register src="../../CustomTools/UserControls/CalculatorModelControl3.ascx" tagname="CalculatorModelControl" tagprefix="uc2" %>
                    ...
                    <igtbar:UltraWebToolbar ID="uwToolBar" runat="server">
                        ...
                        <Items>
                            <igtbar:TBarButton DisabledImage="" HoverImage="" Image="~/images/16x16_back.png"
                                ...
                                HoverStyle-CssClass="enrollmentMenuButtonHover" DefaultStyle-Width="100px">
                                <Images>
                                ...
                                <asp:Panel>
                                    <table cellpadding="0" cellspacing="0" width="100%" id="Table2" runat="server">
                                        <tr>
                                            ...
                                            onmouseout="this.className='enrollmentMenuButton';" style="width: 100%; vertical-align: middle;
                                            text-align: center; white-space:nowrap">
                                                <img id="Img2" align="absmiddle"  style="margin: 0px;" src="~/images/16x16_check.png" runat="server" alt="" />
                                                   3PV
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <%--CHOLT 7/24/2020--%>
                            <igtbar:TBCustom ID="tabPrivicaUser" runat="server" Key="Custom8" Width="50px" Visible="true">
                                <asp:Panel>
                                    <table cellpadding="0" cellspacing="0" width="100%" id="Table6" runat="server">
                                        <tr>
                                            ...
                                            onmouseout="this.className='enrollmentMenuButton';" style="width: 100%; vertical-align: middle;
                                            text-align: center; white-space:nowrap">
                                            <%--<img id="Img3" align="absmiddle"  style="margin: 0px;" src="~/images/16x16_check.png" runat="server" alt="" />--%>
                                                   PrivicaQA
                                            </td>
                                        </tr>
                                    </table>
...
<asp:Content ID="cphBody" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <%--CHOLT 7/24/2020 --%>
    <div id="privicaQApop" visible="false" runat="server" style="position:absolute; z-index:3; height:250px; width:350px; background-color:#e3e3e3; text-align:left; margin-left:550px; margin-right:auto; margin-top:150px; margin-bottom:auto; border:solid;">
        <div style="border-bottom: medium; background-color: #a3d3ff; width: 350px; border-bottom: solid;">Privica QA</div>    
        ...
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:LinkButton id="PrivQASubmit" runat="server">Submit</asp:LinkButton>
    </div>
            ...
            <td valign="top">
                ...
                <table class="window">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtHomePrinciple" Width="150px"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtHomeValue" Width="150px" TabIndex="8"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txt401K" Width="150px" TabIndex="8"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtSavChecking" Width="150px" TabIndex="9"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtOtherAssets" Width="150px" TabIndex="10"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtOtherDebts" Width="150px" TabIndex="11"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <font color="red">Monthly Income</font>
                        </td>
                        <td>
                            $
                        </td>
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtIncome" Width="150px" TabIndex="12"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtGroceries" Width="150px" TabIndex="13"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtCarIns" Width="150px" TabIndex="14"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtHealthIns" Width="150px" TabIndex="15"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtUtilities" Width="150px" TabIndex="16"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtPhoneBill" Width="150px" TabIndex="17"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtHomeIns" Width="150px" TabIndex="18"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtCarPymt" Width="150px" TabIndex="19"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtAutoFuel" Width="150px" TabIndex="20"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtDiningOut" Width="150px" TabIndex="21"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtEntertainment" Width="150px"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtHousePymt" Width="150px" TabIndex="22"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox CssClass="entry" runat="server" ID="txtOtherMthly" Width="150px" TabIndex="22"
                                Style="text-align: right;" />
                        </td>
                    </tr>
                    <tr>
            ...
            <td valign="top">
                <table class="window">
                    <tr>
                        <td>
                            <h3>
                                <table visible="true" width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td>
                                            <b>Creditors</b>
                                        </td>
                                        <td style="white-space:nowrap;align-content:center">
                                            <a id="lnkAddCreditors" runat="server" class="lnk" href="javascript:AddCreditors();">
                                                <img style="margin-right:5px;" src="~/images/16x16_trust.png" runat="server" border="0"
                                                    align="absmiddle" />Add Creditor</a>
                                            <span id="spanCredSep" runat="server" visible="True">&nbsp;|&nbsp;</span>
                                            ...
                                            <a id="aImportCreditors" runat="server" class="lnk" visible="True" href="#">
                                                <img style="margin-right:5px;" src="~/images/16x16_creditcardarrow.png" runat="server"
                                                    border="0" align="absmiddle" />Import Creditors </a>
                                            <span id="spanCredSep2" runat="server" visible="True">&nbsp;|&nbsp;</span>  
                                       </td>     
