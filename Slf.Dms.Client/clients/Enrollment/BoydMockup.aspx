<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="BoydMockup.aspx.vb" Inherits="Clients_Enrollment_BoydMockup" %>
                ...
                <div class="portlet-content">
                    ...
                    <div class="portlet-content">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NetAmount" HeaderText="Net Amount" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headItem5" Width="80px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem2" Width="80px" />
                                <FooterStyle HorizontalAlign="right" CssClass="footitem" />
                            </asp:BoundField>
