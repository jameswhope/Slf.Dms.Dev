...
Partial Class Clients_Enrollment_DashboardAgencyJQ
    ...
    Private Sub LoadGridDateRange()
        ...
        dsOutput = SqlHelper.GetDataSet("stp_MarketingDashboardExternal2", , params)
    ...
    Private Sub LoadGridDateRangeDays()
        ...
        For i As Integer = 0 To days
            ...
            If i = 0 Then
                dsOutput = SqlHelper.GetDataSet("stp_MarketingDashboardExternal2", , params)
            Else
                dsOutput.Merge(SqlHelper.GetDataSet("stp_MarketingDashboardExternal2", , params))
            End If
    ...
    Private Sub BuildGrid(ByVal dsOutput As DataSet)
        ...
        parentCol(1) = dsOutput.Tables(1).Columns("productcode")

        childCol(0) = dsOutput.Tables(2).Columns("description")
        childCol(1) = dsOutput.Tables(2).Columns("productcode")

        dsOutput.Relations.Add("DescriptionProduct", parentCol, childCol)
        ...
        Next
        ltrTree.Text = "<table id=""tbtree"" class=""rawtb""><thead><tr><th>Date/Product/Rep.</th><th>Total Leads</th><th>Approved</th><th>Pending</th><th>QNI</th><th>DNQ</th><th>Bad Leads</th><th>Pipeline</th><th>New</th><th>No Contact</th></tr></thead>" & sb.ToString & "</table>"
    End Sub
    ...
    Private Sub LoadLeads(ByVal SortExpression As String)
        ...
        If Len(hdnVendor.Value) > 0 Then
            ...
            lblFilters.Value &= " > " & hdnVendor.Value
        Else
        ...
        Dim tbl As DataTable = SqlHelper.GetDataTable("stp_MarketingDashboardDetailExternal2", CommandType.StoredProcedure, params)
