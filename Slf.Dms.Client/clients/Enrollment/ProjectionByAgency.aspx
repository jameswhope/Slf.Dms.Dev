<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ProjectionByAgency.aspx.vb" Inherits="Clients_Enrollment_BoydMockup" %>
...
<%--                        <td>
            ...
            <div class="portlet">                
                    <div class="portlet-content">
                        ...
                        Width="100px" BorderStyle="None" BorderWidth="0px" CellPadding="3" CellSpacing="0" ForeColor="Black"
                        ...
                        <Columns>         
                            <%--<asp:BoundField DataField="Empty" HeaderText="" >
                            ...
                            <asp:BoundField DataField="ActiveClients" HeaderText="Active Clients" >
                    ...
                    <div class="portlet-content">
                        <asp:GridView ID="gvFeesRemaining" runat="server" AutoGenerateColumns="False" 
                        Width="100px" BorderStyle="None" BorderWidth="0px" CellPadding="3" CellSpacing="0" ForeColor="Black"
                        GridLines="None" AllowSorting="True" AlternatingRowStyle-CssClass="griditemalt" EmptyDataText="No Data Found" EmptyDataRowStyle-CssClass="emptyrow" >
                        <Columns>         
                            <%--<asp:BoundField DataField="Empty" HeaderText="" >
                            ...
                            <asp:BoundField DataField="FeesBooked" HeaderText="Booked Receivables" HtmlEncode="false" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headitem5" Width="100px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem" Width="100px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>      
