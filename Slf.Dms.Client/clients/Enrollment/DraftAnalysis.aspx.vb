...
Partial Class Clients_Enrollment_DraftAnalysis
...
#Region "Page Event Handlers"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkExport.Click
        ...
        Dim filename As String = "DraftAnalysis.csv"
...
#Region "Private Routines"
    ...
    Private Sub LoadLeads(ByVal gvLeads As GridView, ByVal FromDate As String, ByVal ToDate As String)
        Try
            ...
            Dim procname As String = "stp_DraftAnalysisReport2"
            ...
            Dim dt As DataTable
            dt = SqlHelper.GetDataTable(procname, CommandType.StoredProcedure, params2.ToArray)
