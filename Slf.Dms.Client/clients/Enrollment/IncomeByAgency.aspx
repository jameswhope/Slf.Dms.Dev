<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="IncomeByAgency.aspx.vb" Inherits="Clients_Enrollment_BoydMockup" %>
...
<%--                        <td>
            ...
            <div class="portlet">
                <div class="portlet-content">
                        ...
                        Width="250px" BorderStyle="None" BorderWidth="0px" CellPadding="3" CellSpacing="0" ForeColor="Black"
                        GridLines="None" AllowSorting="True" AlternatingRowStyle-CssClass="griditemalt" EmptyDataText="No Data Found" EmptyDataRowStyle-CssClass="emptyrow" >
                        <Columns>         
                            <asp:BoundField DataField="Column1" HeaderText="" >
                                <HeaderStyle HorizontalAlign="right" CssClass="headitem5" Width="150px"/>
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="150px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="Column2" HeaderText="Calculation">
                                <HeaderStyle HorizontalAlign="right" CssClass="headitem5" Width="100px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem" Width="100px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>                 
                            ...
                            <asp:BoundField DataField="Commission" HeaderText="Fee Amount" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headitem5" Width="100px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem" Width="100px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="Chargeback" HeaderText="Chargebacks" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headItem5" Width="100px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem" Width="100px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="CreditReports" HeaderText="Credit Reports" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="100px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="100px" />
                                <FooterStyle CssClass="footitem" />                             
                            </asp:BoundField>
                            <asp:BoundField DataField="NetAmount" HeaderText="Net Amount" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headItem5" Width="100px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem2" Width="100px" />
                    ...
                    <div class="portlet-content">
                        ...
                        <Columns>
                            <asp:BoundField DataField="AccountNumber" HeaderText="Client Acct#" HtmlEncode="false">
                            ...
                            <asp:BoundField DataField="ClientName" HeaderText="Client Name" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="120px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="120px" />
                                <FooterStyle CssClass="footitem" />                             
                            </asp:BoundField>
                            <asp:BoundField DataField="PaidTo" HeaderText="Paid To" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="220px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="220px" />
                                <FooterStyle CssClass="footitem" />                             
                            </asp:BoundField>
                            <asp:BoundField DataField="Agency" HeaderText="Agency Name" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="150px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="150px" />
                                <FooterStyle CssClass="footitem" />                             
                            </asp:BoundField>
                            <asp:BoundField DataField="Product" HeaderText="Product" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="150px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="150px" />
                                <FooterStyle CssClass="footitem" />                             
                            </asp:BoundField>
                            <asp:BoundField DataField="SalesAgent" HeaderText="Sales Agent" HtmlEncode="false">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="100px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="100px" />
                                <FooterStyle CssClass="footitem" />                             
                            </asp:BoundField>
                            <asp:BoundField DataField="PaymentDate" HeaderText="Payment Date" dataformatstring="{0:MM/dd/yyyy}">
                                <HeaderStyle HorizontalAlign="left" CssClass="headitem5" Width="90px"/>
                                <ItemStyle HorizontalAlign="left" CssClass="griditem" Width="90px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>
                            <asp:BoundField DataField="NextDepositDay" HeaderText="Next Deposit Day" dataformatstring="{0:MM/dd/yyyy}">
                                <HeaderStyle HorizontalAlign="left" CssClass="headItem5" Width="90px" />
                                <ItemStyle HorizontalAlign="left" CssClass="griditem2" Width="90px"/>
                                <FooterStyle HorizontalAlign="left" CssClass="footitem" /> 
                            </asp:BoundField>
                            <%--<asp:BoundField DataField="AmountPaid" HeaderText="Amount Paid" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headitem5" Width="80px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem" Width="80px" />
                                <FooterStyle CssClass="footitem" /> 
                            </asp:BoundField>--%>
                            <asp:BoundField DataField="Commission" HeaderText="Sub-Servicer Gross Fees" dataformatstring="{0:c}">
                            ...
                            <asp:BoundField DataField="NetAmount" HeaderText="Sub-Servicer  Net Fees" dataformatstring="{0:c}">
                                <HeaderStyle HorizontalAlign="right" CssClass="headItem5" Width="120px"/>
                                <ItemStyle HorizontalAlign="right" CssClass="griditem2" Width="120px" />
                                <FooterStyle HorizontalAlign="right" CssClass="footitem" />
                            </asp:BoundField>
                            <%--<asp:BoundField DataField="NextDepositDay" HeaderText="Next Deposit Day">
                                <HeaderStyle HorizontalAlign="right" CssClass="headItem5" Width="110px" />
                                <ItemStyle HorizontalAlign="right" CssClass="griditem2" Width="110px"/>
                                <FooterStyle HorizontalAlign="right" CssClass="footitem" /> 
                            </asp:BoundField> --%>                           
                        </Columns>
                    </asp:GridView>
