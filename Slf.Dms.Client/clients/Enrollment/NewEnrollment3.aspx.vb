...
Partial Class Clients_Enrollment_NewEnrollment3
...
#Region "Methods"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As System.EventArgs) Handles Me.LoadComplete
        ...
        If (UserID = 2374 Or UserID = 493 Or UserID = 1848) Then
            Response.Redirect(String.Format("~/clients/enrollment/newenrollment2.aspx?id={0}&p1=0&p2=0&s=1", aID))
        End If
    ...
    Public Sub SaveHardshipData(ByVal clientID As Integer)
        ...
        Using cmd As New SqlClient.SqlCommand
            ...
            cmd.Parameters.Add(New SqlClient.SqlParameter("@MonthlyIncome_Client_OtherAssets", txtOtherAssets.Text.ToString))
