<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false"
    CodeFile="DashboardAgencyRep.aspx.vb" Inherits="Clients_Enrollment_DashboardAgencyRep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopup(dates, statusgroup, product, rep) {
            $("#<%=hdnDates.ClientID %>").val(dates);
            $("#<%=hdnStatusGroup.ClientID %>").val(statusgroup);
            $("#<%=hdnProduct.ClientID %>").val(product);
