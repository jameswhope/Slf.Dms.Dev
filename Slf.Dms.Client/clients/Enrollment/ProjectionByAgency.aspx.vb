...
#Region "Private Routines"
    ...
    Private Sub LoadLeads(ByVal gvLeads As GridView, ByVal FromDate As String, ByVal ToDate As String)
        Try
            ...
            Dim procname As String = "stp_FixedFeeProjections2"
            params2.Add(New SqlParameter("defaultcommrecid", _commrecid))
            ...
            dt2 = ds.Tables(1)
            gvClients.DataSource = dt2
            gvClients.DataBind()

            Dim dt3 As New DataTable
            dt3 = ds.Tables(2)
            gvFeesRemaining.DataSource = dt3
            gvFeesRemaining.DataBind()
