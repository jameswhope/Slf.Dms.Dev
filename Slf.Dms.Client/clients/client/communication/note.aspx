...
<body onload="SetFocus('<%= txtMessage.ClientID %>');" style="background-image:url(<%= ResolveUrl("~/images/back.bmp") %>); background-position:left top; background-repeat:repeat-x;">
    ...
    {
        var url = '<%= ResolveUrl("~/util/pop/addrelation.aspx?to=note&toid=" & NoteID & "&client&dependencyid=" & ClientID) %>';
         window.dialogArguments = window;
         currentModalDialog = $('<div/>').appendTo("body").modaldialog({url: url,
                   title: "Add Relation to Note",
	...
	{
       var url = '<%= ResolveUrl("~/delete.aspx?t=Note&p=note") %>';
       window.dialogArguments = window;
       currentModalDialog = $('<div/>').appendTo("body").modaldialog({url: url,
                   title: "Note",
                   dialogArguments: window,
                        ...
                        <td style="width:50%;" valign="top">
                            <table style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="5" cellspacing="0">
                                ...
                                <tr id="trMessage" runat="server">
                                    <td class="entrytitlecell" colspan="2">Message:<br /><asp:textbox TabIndex="3" cssclass="entry" runat="server" id="txtMessage" Rows="10" TextMode="MultiLine" MaxLength="5000" Columns="50" style="width:50em"></asp:textbox></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
