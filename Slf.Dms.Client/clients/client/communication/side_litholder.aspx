<%@ Page Language="VB" AutoEventWireup="false" CodeFile="side_litholder.aspx.vb" Inherits="side_litholder" %>
...
<body style="margin-top:0; margin-left:0; margin-right:0; margin-bottom:0; border:none" onunload="CheckForClose();" >
    <form id="form1" runat="server">
        <iframe style="width:100%;height:100%;border:none" border="0" frameborder="0" scrolling="auto" src="side_lit.aspx?<%=QueryString %>"></iframe>
    </form>
</body>
</html>