    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not qs Is Nothing Then
            ...
            Else
                ...
                RelationTypeId = (DataHelper.FieldLookup("tblNoteRelation", "RelationTypeId", "NoteId =" & NoteID))
                If RelationTypeId = "19" Then
                    MatterId = DataHelper.FieldLookup("tblnoterelation", "RelationID", " RelationTypeID=19 and NoteID=" & NoteID)
                End If
            End If
