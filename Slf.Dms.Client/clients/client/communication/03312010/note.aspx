                                    ...
                                    <td colspan="2">
                                        <table onmouseover="Grid_RowHover(this, true)" onmouseout="Grid_RowHover(this,false)" class="list" style="font-family:tahoma;font-size:11px;width:100%;" cellspacing="0" cellpadding="3">
                                            ...
                                            <asp:repeater runat="server" id="rpRelations">
                                                <itemtemplate>
                                                    <a href="<%#ResolveURL(ctype(DataBinder.Eval(Container.DataItem, "NavigateURL"),string).replace("$clientid$",ClientID).replace("$accountid$",AccountId).replace("$x$",DataBinder.Eval(Container.DataItem, "RelationID")))  %>"
                                                    <tr>
