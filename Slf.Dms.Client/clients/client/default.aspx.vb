        ...
        Select Case StateID
            Case 7
                Select Case ClientHelper.GetLanguage(DataClientID)
                    Case 2      'spanish
                        mosslerMSG.Append("Debido a cambios en la ley, El Bufete de abogados de Mossler ya no representará a clientes en Connecticut. Estos cambios no incluyen a abogados con licencia de ")
                        mosslerMSG.Append("Connecticut. Por lo tanto, hemos arreglado con el abogado Glen A. Kurtis, con licencia de Connecticut, para proporcionarle representación legal continua si usted da su ")
                        mosslerMSG.Append("consentimiento. Si usted no da su consentimiento, con mucho gusto reembolsaremos su dinero. Usted estará recibiendo una carta y otros materiales de El Bufete de ")
                        mosslerMSG.Append("abogados de Mossler en el futuro próximo.</br>")
                        mosslerMSG.AppendLine("<b>Si el cliente tiene preguntas con respecto a su CANTIDAD de REEMBOLSO o BALANCE de CDA:</b><br> por favor transferir a Retención (7498) directamente.")
