<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="true" CodeFile="scanning.aspx.vb" Inherits="clients_client_scanning" title="DMP - Client - Scanning" %>
                ...
                <table style="font-family:tahoma;font-size:11px;width:620px;height:100%;vertical-align:middle;text-align:center;word-wrap:normal;" border="0" cellpadding="0" cellspacing="5">
                    ...
                    <tr>
                        <td colspan="4">
                            ...
                            <OBJECT ID="csxi" CLASSID="clsid:62E57FC5-1CCD-11D7-8344-00C1261173F0" CODEBASE="csximage.cab"  width="627px" height="480px" border="1px solid black"></OBJECT>
                        </td>
                    </tr>
                </table>
            </td>
