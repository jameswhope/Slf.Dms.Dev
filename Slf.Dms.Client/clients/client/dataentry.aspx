    ...
    <asp:Panel runat="server" ID="pnlMenuView" visible="false">
        <table cellpadding="0" cellspacing="0" class="menuTable" onselectstart="return false">
            <tr>
                ...
                <td><img width="8" height="28" src="~/images/spacer.gif" runat="server" /></td>
                <td nowrap="nowrap">
                <a class="menuButton" href="#" onclick="">
                </a>
                </td>
            </tr>
        </table>
...
function RequiredSpouseExist()
{
        ...
        || imAlternatePhone2.value.length > 0 || imCellPhone2.value.length > 0 || txtEmailAddress2.value.length > 0)
    {
        ...
        //else if(cboStateID.value == "1" || cboStateID.value == "34" || cboStateID.value == "42")
        //{
        //    alert("We do not accept clients from AL, NC or SC any longer. Please advise your supervisor. This record will not be saved or resolved.");
        //    return false;
        //}
    }
...
<table class="stanTblNoH" cellpadding="0" cellspacing="15" border="0">
    ...
    <tr>
        <td colspan="3" style="padding-left:20;">
            ...
            <input type="checkbox" runat="server" ID="chkReceivedDeposit" /><label for="<%= chkReceivedDeposit.ClientID() %>">&nbsp;The initial deposit has been received from this client.</label>
        </td>
    </tr>
    <tr>
        ...
        <td valign="top"> <!-- non-grid fields cell -->
            ...
            <table style="width:380;" class="stanTblNoH" cellpadding="0" cellspacing="3" border="0">
                <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList TabIndex="42" class="entry" id="monthlyFee" runat="server" style="font-size:11px">
                                        <asp:ListItem value="55.00" Text="55.00" />
                                        <asp:ListItem value="65.00" Text="65.00" />
                                        <asp:ListItem value="100.00" Text="100.00" />
                                        <asp:ListItem value="130.00" Text="130.00" />
                                        <asp:ListItem value="150.00" Text="150.00" />
                                        <asp:ListItem value="200.00" Text="200.00" />
                                        <asp:ListItem value="225.00" Text="225.00" />
                                        <asp:ListItem value="250.00" Text="250.00" />
                                    </asp:DropDownList>
                                    <asp:PlaceHolder ID="plhMonthlyFee" runat="server">
                                        <asp:TextBox ID="txtMonthlyFee" runat="server" ReadOnly = "true"  width="40px" CssClass="entry"></asp:TextBox>
                                        <asp:Label ID="lblMonthlyFee" runat="server" Text=""></asp:Label>
                                    </asp:PlaceHolder>
                                </td>
                            </tr>
