<%@ Control Language="VB" AutoEventWireup="false" CodeFile="1.ascx.vb" Inherits="clients_client_docs_sheets_1" %>
...
function Record_Save()
{
    ...
    if (RequiredExist())
    {
        ...
        ShowMessageBody("...Uploading LSA images and entering data...");
...
//    // --------------------------
//    // THE BELOW SECTIONS ARE COMMENTED OUT BECAUSE THEY ARE NOT REQUIRED HERE
//    // --------------------------
...
function LoadControls()
{
    if (txtSetupFee == null)
    {
        txtSetupFee = document.getElementById("<%= txtSetupFee.ClientID %>");
        txtSetupFeePercentage = document.getElementById("<%= txtSetupFeePercentage.ClientID %>");
        txtSettlementFeePercentage = document.getElementById("<%= txtSettlementFeePercentage.ClientID %>");
        txtAdditionalAccountFee = document.getElementById("<%= txtAdditionalAccountFee.ClientID %>");
        txtReturnedCheckFee = document.getElementById("<%= txtReturnedCheckFee.ClientID %>");
        txtOvernightDeliveryFee = document.getElementById("<%= txtOvernightDeliveryFee.ClientID %>");
                ...
                <tr>
                    <td colspan="2" style="padding-left:15;">
                        <table style="font-family:tahoma;font-size:11px;" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="width:150;padding-top:2;" valign="top">The scanned LSA images:</td>
                    ...
                    <td colspan="2" style="padding-left:15;">
                        <table style="width:100%;font-family:tahoma;font-size:11px;" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="width:45;"><asp:TextBox style="text-align:right;" class="entry" runat="server" ID="txtSetupFee"></asp:TextBox></td>
                                <td style="width:120;padding-left:15;">Additional account fee:</td>
                                <td style="width:15;" align="center">$</td>
                                <td style="width:45;"><asp:TextBox style="text-align:right;" class="entry" runat="server" ID="txtAdditionalAccountFee"></asp:TextBox></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="width:150;">Setup fee percentage:</td>
                                <td style="width:15;" align="center">%</td>
                                <td style="width:45;"><asp:TextBox style="text-align:right;" class="entry" runat="server" ID="txtSetupFeePercentage"></asp:TextBox></td>
                                <td style="width:120;padding-left:15;">Returned check fee:</td>
                                <td style="width:15;" align="center">$</td>
                                <td style="width:45;"><asp:TextBox style="text-align:right;" class="entry" runat="server" ID="txtReturnedCheckFee"></asp:TextBox></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="width:150;">Settlement fee percentage:</td>
                                <td style="width:15;" align="center">%</td>
                                <td style="width:45;"><asp:TextBox style="text-align:right;" class="entry" runat="server" ID="txtSettlementFeePercentage"></asp:TextBox></td>
                                <td style="width:120;padding-left:15;">Overnight delivery fee:</td>
                                <td style="width:15;" align="center">$</td>
                                <td style="width:45;"><asp:TextBox style="text-align:right;" class="entry" runat="server" ID="txtOvernightDeliveryFee"></asp:TextBox></td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
                    </td>
