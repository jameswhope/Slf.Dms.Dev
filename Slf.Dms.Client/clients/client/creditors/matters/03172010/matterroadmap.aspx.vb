...
#End Region
    ...
    Private Sub SetRollups()
        ...
        If Action = "a" Then
            CommonTasks.Add("<a style=""color:rgb(51,118,171);"" class=""lnk"" href=""" & ResolveUrl("~/clients/client/creditors/accounts/account.aspx?id=" & ClientID & "&aid=" & AccountId & "") & """><img style=""margin-right:8px;"" border=""0"" runat=""server"" src=""" & ResolveUrl("~/images/16x16_cancel.png") & """ align=""absmiddle""/>Cancel and close</a>")
        ElseIf Action = "m" Then
            CommonTasks.Add("<a style=""color:rgb(51,118,171);"" class=""lnk"" href=""" & ResolveUrl("~/clients/client/creditors/accounts/account.aspx?id=" & ClientID & "&a=m&aid=" & AccountId & "") & """><img style=""margin-right:8px;"" border=""0"" runat=""server"" src=""" & ResolveUrl("~/images/16x16_cancel.png") & """ align=""absmiddle""/>Cancel and close</a>")
        End If
    ...
    Private Sub LoadMatterAudits()
        ...
        Try
            ...
            'for header creation
            strHTML = "<table onselectstart=""return false;"" class=""rmgTable"" cellSpacing=""0"" cellPadding=""0"" border=""0"">  <tr>    <td class=""rmgHeaderStatus""></td>    <td class=""rmgHeaderStatus"">MatterId</td>    <td class=""rmgHeaderStatus""></td>  <td class=""rmgHeaderStatus"">Action</td>      <td class=""rmgHeaderCreated"">When</td>      <td class=""rmgHeaderFacilitator"">Facilitated By</td>  </tr></table>"
            ...
            While rdMatter.Read()
                ...
                "<table class=""rmgCellTable"" cellpadding=""0"" cellspacing=""0"" border=""0""> <tr><td class=""rmgCellStatus"" style=""width:35px""><a class=""lnk"" href=""#""><img border=""0"" runat=""server"" src=""" & ResolveUrl("~/images/matter.jpg") & """/></a></td>  <td></td> <td class=""rmgCellStatus"" align=""left"">" & MatterID & "</td>  <td class=""rmgCellStatus"">" & strMatterDesc & "</td><td class=""rmgCellCreated"">" & strDate & "</td>     <td class=""rmgCellFacilitator"">" & strCreatedBy & "&nbsp;</td> </tr></table></td>  </tr></table>"
                ...
                While rd.Read()
                    ...
                    If DatabaseHelper.Peel_int(rd, "seq") = 1 Then
                        ...
                        strFieldName = strFieldName.Replace("MatterStatusCodeId", "Matter Status").Replace("AttorneyId", "Attorney").Replace("CreditorInstanceId", "Creditor Instance").Replace("MatterTypeId", "Matter Type").Replace("MatterStatusId", "Matter Status").Replace("MatterSubStatusId", "Matter Sub Status")
                     ...
                     0, _
                       ...
                       "")
                        ...
                        Try
                            ...
                            While rdChilds.Read()
                                Dim intChildTaskId As Integer = DatabaseHelper.Peel_int(rdChilds, "TaskID")
                                ...
                                Dim rdNotes As IDataReader = Nothing
                                Dim cmdNotes As IDbCommand = ConnectionFactory.Create().CreateCommand
                                Try
                                    cmdNotes.Connection.Open()
                                    'cmdNotes.CommandText = "select  tbltask.taskid, tbltask.Resolved,   tbltask.Description, tbltask.Due , " & _
                                    '    " tblcreatedby.firstname + ' ' + tblcreatedby.lastname as createdbyname ,tbltask.created, '' as change " & _
                                    '    " from tbltask left outer join tbluser as tblcreatedby on tbltask.createdby = tblcreatedby.userid  " & _
                                    '    " WHERE tbltask.parenttaskid=@parenttaskid"
                                    cmdNotes.CommandText = "select 0 as taskid, null Resolved,   n.value, null as Due , " & _
                                        " tblcreatedby.firstname + ' ' + tblcreatedby.lastname as createdbyname ," & _
                                        " n.created, '' as change " & _
                                        "from tbltasknote tn, tbltask, tblnote n left outer join " & _
                                        "tbluser as tblcreatedby on n.createdby = tblcreatedby.userid " & _
                                        "where n.noteid=tn.noteid and tbltask.taskid=tn.taskid and tn.taskid=@TaskId"
                                    cmdNotes.CommandType = CommandType.Text
                                    DatabaseHelper.AddParameter(cmdNotes, "TaskId", intChildTaskId)
                                    rdNotes = cmdNotes.ExecuteReader()


                                    While rdNotes.Read()
                                        Dim taskNotes As New Task(DatabaseHelper.Peel_int(rdNotes, "TaskID"), _
                                             0, _
                                             0, _
                                             "", _
                                             0, _
                                             ...
                                             0, _
                                             "", _
                                             DatabaseHelper.Peel_string(rdNotes, "value"), _
                                             0, _
                                             "", _
                                             DatabaseHelper.Peel_date(rdNotes, "Due"), _
                                             DatabaseHelper.Peel_ndate(rdNotes, "Resolved"), _
                                           0, _
                                             "", _
                                             0, _
                                             "", _
                                             DatabaseHelper.Peel_date(rdNotes, "Created"), _
                                             0, _
                                             DatabaseHelper.Peel_string(rdNotes, "CreatedByName"), _
                                             Nothing, _
                                             0, _
                                             "")
                                        strHTML &= "<tr>    <td class=""rmgCellTask"">        <table class=""rmgCellTaskTable"" cellpadding=""3"" cellspacing=""0"" border=""0""><tr>  <td class=""rmgCellTaskImage""><img align=""absmiddle"" class=""rmgImage"" runat=""server"" src=""" & ResolveUrl("~/images/rootend.png") & """ border=""0""><img runat=""server"" src=""" & ResolveUrl("~/images/16x16_calendar.png") & """  border=""0"" align=""absmiddle""/></td>  <td class=""rmgCellTaskStatus"" align=""left"">" & taskNotes.Description & "</td>  <td class=""rmgCellTaskResolved""><a style=""color:rgb(0,129,0);"" href=""" & ResolveUrl("~/tasks/task/resolve.aspx?id=" & taskNotes.TaskID & "") & """ class=""lnk"">" & taskNotes.StatusFormatted & "</a><br><font class=""rmgCellTaskResolvedDate"">" & taskNotes.Resolved & "</font></td>  <td class=""rmgCellTaskCreated"">" & taskNotes.Created & "</td>  <td class=""rmgCellTaskFacilitator"">" & taskNotes.CreatedByName & "&nbsp;</td></tr>        </table>    </td></tr> "

                                    End While
                                Catch ex As Exception
                                Finally
                                    DatabaseHelper.EnsureReaderClosed(rdNotes)
                                    DatabaseHelper.EnsureConnectionClosed(cmdNotes.Connection)
                                End Try

                            End While


                            Dim rdChildNotes As IDataReader = Nothing
                            Dim cmdChildNotes As IDbCommand = ConnectionFactory.Create().CreateCommand
                            Try
                                cmdChildNotes.Connection.Open()
                                'cmdChildNotes.CommandText = "select  tbltask.taskid, tbltask.Resolved,   tbltask.Description, tbltask.Due , " & _
                                '    " tblcreatedby.firstname + ' ' + tblcreatedby.lastname as createdbyname ,tbltask.created, '' as change " & _
                                '    " from tbltask left outer join tbluser as tblcreatedby on tbltask.createdby = tblcreatedby.userid  " & _
                                '    " WHERE tbltask.parenttaskid=@parenttaskid"
                                cmdChildNotes.CommandText = "select 0 as taskid, null Resolved,   n.value, null as Due , " & _
                                    " tblcreatedby.firstname + ' ' + tblcreatedby.lastname as createdbyname ," & _
                                    " n.created, '' as change " & _
                                    "from tbltasknote tn, tbltask, tblnote n left outer join " & _
                                    "tbluser as tblcreatedby on n.createdby = tblcreatedby.userid " & _
                                    "where n.noteid=tn.noteid and tbltask.taskid=tn.taskid and tn.taskid=@TaskId"
                                cmdChildNotes.CommandType = CommandType.Text
                                DatabaseHelper.AddParameter(cmdChildNotes, "TaskId", iTaskId)
                                rdChildNotes = cmdChildNotes.ExecuteReader()


                                While rdChildNotes.Read()
                                    Dim taskNotes As New Task(DatabaseHelper.Peel_int(rdChildNotes, "TaskID"), _
                                         0, _
                                         0, _
                                         "", _
                                         0, _
                                         ...
                                         0, _
                                         "", _
                                         DatabaseHelper.Peel_string(rdChildNotes, "value"), _
                                         0, _
                                         "", _
                                         DatabaseHelper.Peel_date(rdChildNotes, "Due"), _
                                         DatabaseHelper.Peel_ndate(rdChildNotes, "Resolved"), _
                                       0, _
                                         "", _
                                         0, _
                                         "", _
                                         DatabaseHelper.Peel_date(rdChildNotes, "Created"), _
                                         0, _
                                         DatabaseHelper.Peel_string(rdChildNotes, "CreatedByName"), _
                                         Nothing, _
                                         0, _
                                         "")
                                    strHTML &= "<tr>    <td class=""rmgCellTask"">        <table class=""rmgCellTaskTable"" cellpadding=""3"" cellspacing=""0"" border=""0""><tr>  <td class=""rmgCellTaskImage""><img align=""absmiddle"" class=""rmgImage"" runat=""server"" src=""" & ResolveUrl("~/images/rootend.png") & """ border=""0""><img runat=""server"" src=""" & ResolveUrl("~/images/16x16_calendar.png") & """  border=""0"" align=""absmiddle""/></td>  <td class=""rmgCellTaskStatus"" align=""left"">" & taskNotes.Description & "</td>  <td class=""rmgCellTaskResolved""><a style=""color:rgb(0,129,0);"" href=""" & ResolveUrl("~/tasks/task/resolve.aspx?id=" & taskNotes.TaskID & "") & """ class=""lnk"">" & taskNotes.StatusFormatted & "</a><br><font class=""rmgCellTaskResolvedDate"">" & taskNotes.Resolved & "</font></td>  <td class=""rmgCellTaskCreated"">" & taskNotes.Created & "</td>  <td class=""rmgCellTaskFacilitator"">" & taskNotes.CreatedByName & "&nbsp;</td></tr>        </table>    </td></tr> "
                            ...
                            Catch ex As Exception
                            Finally
                                DatabaseHelper.EnsureReaderClosed(rdChildNotes)
                                DatabaseHelper.EnsureConnectionClosed(cmdChildNotes.Connection)
                            End Try
