<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="false"
    CodeFile="matterroadmap.aspx.vb" Inherits="clients_client_matters_matterroadmap"
    Title="DMP - Client Matter RoadMap" %>
...
function DeleteConfirm(RoadmapId){
        ...
        showModalDialog("<%= ResolveUrl("~/util/pop/confirmholder.aspx?f=Delete&t=Delete Roadmap&m=Are you sure you want to delete this roadmap?") %>", window, "status:off;help:off;dialogWidth:400px;dialogHeight:300px;");
}
