<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Intake.aspx.vb" Inherits="Clients_client_creditors_matters_Intake" %>
...
<script>
   ...
   // var txtSource2 = null;
    ...
    function SavePostJudgmentIntake() {
        //return false;
        LoadControls(); 
        if (RequiredExist()) {
            Record_Display("Saving changes and attaching to matter instance...");
    ...
    function LoadControls() {
        if (ddlLDocument == null) {
           ...
           // txtSource2 = document.getElementById("<%= txtSource2.ClientID %>");
            ...
            cmbClients=document.getElementById("<%= cmbClients.ClientID %>");
            ddlLanguage=document.getElementById("<%= ddlLanguage.ClientID %>");
    ...
    function RequiredExist() {
        ...
        RemoveBorder(txtLevies1);
          ...
          RemoveBorder(document.getElementById("cmbRental2"));
            RemoveBorder(document.getElementById("txtRent2"));
           ...
           RemoveBorder( txtGarnishmentVal);
              ...
              RemoveBorder( txtr3 );
              RemoveBorder( txtr4);
             RemoveBorder( cmbClients);
             RemoveBorder( ddlLanguage);
             
              if (cmbClients.value == "0") {
                ShowMessage("select client name");//Is it your residence is a required field
                AddBorder(cmbClients);
                return false;
            }
        ...
        if (cmbRecType.value == "") {
          ...
          if (ddlLanguage.selectedIndex <= 0) {
            ShowMessage("Language is a required field");
            AddBorder(ddlLanguage);
            return false;
        }
       ...
       /* if (cmbAmtDispute.value == "") {
            ...
            {
                if(document.getElementById("cmbRental1").value=="")
                {
                 ShowMessage("Is this a rental property is a required field");
                 AddBorder(document.getElementById("cmbRental1"));
                    return false;
                }
                else if(document.getElementById("cmbRental1").value=="Yes")
                {
                    if(document.getElementById("txtRent1").value=="")
                    {
                     ShowMessage("How much is the rent is a required field");
                 AddBorder(document.getElementById("txtRent1"));
                    return false;
                    }
                }
            }
                ...
                if (cmbResidence2.value == "Yes") {
                      if(document.getElementById("cmbRental2").value=="")
                        {
                         ShowMessage("Is this a rental property is a required field");
                         AddBorder(document.getElementById("cmbRental2"));
                            return false;
                        }
                        else if(document.getElementById("cmbRental2").value=="Yes")
                        {
                            if(document.getElementById("txtRent2").value=="")
                            {
                                ShowMessage("How much is the rent is a required field");
                                AddBorder(document.getElementById("txtRent2"));
                                return false;
                            }
                        }
                       else if(document.getElementById("cmbRental2").value=="No")
                       {
        ...
        if ((cmbAid.value =="Yes") && (chkr1.checked == false) && (chkr2.checked == false) && (chkr3.checked == false) && (chkr3.checked == false) && (chkr4.checked == false)) {
         ShowMessage(" Please select type of Aid ")
         AddBorder(cmbAid)
         return false;
         }    
         if (cmbAid.value == "Yes") 
...
//        }
        ...
        if (cmbBankAcc.value == "Yes") {
            ...
            if(document.getElementById("radAccountType_0").checked ==false && document.getElementById("radAccountType_1").checked ==false && document.getElementById("radAccountType_2").checked==false)
            {
                ShowMessage(" Account type is a required field");
                AddBorder(document.getElementById("radAccountType_0"));
                return false;
            }
    ...
    function EnableMarketVal()
    {
        if (document.getElementById("<%=chkMarketVal.ClientID%>").checked) {
            document.getElementById("<%=txtMarketVal.ClientID%>").value="";
            document.getElementById("<%=txtMarketVal.ClientID%>").disabled = true;
        }
        else {
            document.getElementById("<%=txtMarketVal.ClientID%>").disabled = false;
        }
    }
    
    function EnableMarketVal2()
    {
        if (document.getElementById("<%=chkMarketVal2.ClientID%>").checked) {
            document.getElementById("<%=txtMarketVal2.ClientID%>").value="";
            document.getElementById("<%=txtMarketVal2.ClientID%>").disabled = true;
        }
        else {
            document.getElementById("<%=txtMarketVal2.ClientID%>").disabled = false;
        }
    }

    function ShowWages()
    {
     if (document.getElementById("<%=cmbWage.ClientID%>").value == "Yes") {
     document.getElementById("dvGarnishment").style.display = "block"
     }else 
        {
        document.getElementById("dvGarnishment").style.display = "none"
     }
...
//        }
    ...
    {
    var resVal = document.getElementById("<%=cmbResidence.ClientID%>").value;
    //tabREstate
       if (resVal == "Yes") 
       {
            ...
            document.getElementById("<%=tabREstate.ClientID%>").style.display = "block"
            document.getElementById("<%=tabnew.ClientID%>").style.display = "block"
        }
        else 
        {
            document.getElementById("<%=tabREstate.ClientID%>").style.display = "block"
            ...
            document.getElementById("<%=tabPro1No.ClientID%>").style.display = "block"
            document.getElementById("<%=tabnew.ClientID%>").style.display = "none"
        }
        
        if (resVal == "Select") {
            document.getElementById("<%=tabREstate.ClientID%>").style.display = "none"
            document.getElementById("<%=tabPro1.ClientID%>").style.display = "none"
    ...
    function CloseIntake(i)
    {
        //alert("Successfully saved and attached to matter instance.");
    ...
    function mute() {
        ...
        parentW.top.mute_call(); 
    }
    function hold() {
        var parentW = window.dialogArguments;
        parentW.top.hold_call(); 
    }
</script>
                ...
                <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="1"
                    ...
                    <tr>
                        <td colspan="2" class="cLEnrollHeader">
                             Client Intake form
                                <img  src="<%=ResolveUrl("~/images/p_hold.png") %>"  title="Hold" style="cursor: hand; width: 16px; height: 16px;" onclick="hold();" />
                                <img  src="<%=ResolveUrl("~/images/p_mute.gif") %>"  title="Mute" style="cursor: hand; width: 16px; height: 16px;" onclick="mute();"/>
                          </td>
                    </tr>
                    <tr>
                    ...
                    <tr id="tdCreatedDetails" runat="server" visible="false">
                        <td height="20">
                            <b>Created By:</b>
                            <asp:Label CssClass="entry2" Text="" ID="lblCreatedBy" runat="server"></asp:Label>
                        </td>
                        <td height="20">
                            <b>Created Date:</b>
                            <asp:Label CssClass="entry2" Text="" ID="lblCreatedDate" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td height="20">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="1"
                                    ...
                                    <td>
                                        <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="1"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="cmbClients" runat="server" CssClass="entry">
                                                    </asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <cc1:InputMask CssClass="entry" Width="120px" ID="txtPhone" runat="server" Mask="(nnn) nnn-nnnn"
                                                        MaxLength="20"></cc1:InputMask>
                                                    &nbsp;<a href="#" onclick="AddressBook();return false;"><img id="Img4" runat="server"
                                                        src="~/images/16x16_addressbook.png" border="0" align="absmiddle" /></a>
                                                </td>
                                                <td align="right">
                                                    E-Mail:
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="cmbRecType" runat="server" CssClass="entry2" Width="145px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlLanguage" runat="server" CssClass="entry2">
                                                        <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                        <asp:ListItem Text="English - US" Value="1"></asp:ListItem>
                                                        <asp:ListItem Text="Spanish" Value="2"></asp:ListItem>
                                                    </asp:DropDownList>
                                                    <%--<asp:TextBox ID="txtLanguage" runat="server" Width="150px" CssClass="entry"></asp:TextBox>--%>
                                                </td>
                                                <td colspan="4">
                                                    &nbsp;
                                                </td>
                                            ...
                                            <tr>
                                                <td valign="top" width="50%">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table id="tabPro1" border="0" runat="server" style="display: none;" width="100%">
                                                                    <tr>
                                                                        <td width="60%">
                                                                ...
                                                                <table id="tabPro1No" border="0" runat="server" style="display: none;" width="100%">
                                                                    <tr>
                                                                        <td width="60%">
                                                ...
                                                <td valign="top" width="50%">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" runat="server" id="tabnew"
                                                        style="display: none">
                                                        <tr>
                                                            <td colspan="2">
                                                                <b>Property 2:</b>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table id="tabPro2No" border="0" runat="server" style="display: none;" width="100%">
                                                                    <tr>
                                                                        <td width="60%">
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table id="tabPro2" border="0" runat="server" style="display: none;" width="100%">
                                                                    <tr>
                                                                        <td width="60%">
                                                                            What year was property purchased?
                                                                        </td>
                                ...
                                <tr>
                                    <td width="100%">
                                        <table id="tabNoIncome" runat="server" style="display: none;" cellpadding="1" cellspacing="0"
                                            width="100%" border="0" class="box">
                                            <tr>
                                                <td width="30%">
                                        ...
                                        <table id="tabIncome" runat="server" style="display: none" cellpadding="1" cellspacing="0"
                                            width="100%" border="0" class="box">
                                            <tr>
                                                <td width="17%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="cmbPer" runat="server" CssClass="entry2">
                                                        ...
                                                        <asp:ListItem Text="Bi-Monthly"></asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    <div style="display: none" id="dvGarnishment">
                                                        <span>&nbsp;&nbsp;Enter info&nbsp;&nbsp;&nbsp;
                                                            <asp:TextBox ID="txtGarnishmentVal" CssClass="entry" runat="server" Width="260px"></asp:TextBox></span>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <td width="100%">
                                        <table id="tabBankAcc" runat="server" style="display: none" width="100%" border="0"
                                            cellpadding="1" cellspacing="0" class="box">
                                            <tr>
                                                <td width="50%">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <span style="display: none">
                                <asp:CheckBox ID="checkMail" runat="server" CssClass="entry" Text="Send Email" /></span>
                        </td>
                        <td align="right">
                            <a tabindex="4" style="color: black" class="lnk" href="javascript: SavePostJudgmentIntake();">
                                Save Intake
...
<script>
    //alert('<%=System.DateTime.Now.ToString("MMddyyyy") %>')
    document.getElementById("txtDOB").value = '<%=System.DateTime.Now.ToString("MM/dd/yyyy")%>'

    document.getElementById("txtFirm").focus();
