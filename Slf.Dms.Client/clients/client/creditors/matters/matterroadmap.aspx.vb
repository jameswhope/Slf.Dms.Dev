            ...
            While rdMatter.Read()
                ...
                While rd.Read()
                    ...
                    If DatabaseHelper.Peel_int(rd, "seq") = 1 Then
                        ...
                        strFieldName = strFieldName.Replace("AttorneyId", "Attorney").Replace("CreditorInstanceId", "Creditor Instance").Replace("MatterTypeId", "Matter Type").Replace("MatterStatusId", "Matter Status").Replace("MatterSubStatusId", "Matter Sub Status")
