<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="false"
    CodeFile="NonDepositMatterinstance.aspx.vb" Inherits="clients_client_creditors_matters_NonDepositMatterInstance"
    Title="DMP - Client - Non Deposit Matter"  ValidateRequest="false"%>
...
//end
    ...
    function TaskClick(TaskID, TaskTypeId)
    {
        ...
        else if(TaskTypeId == 76)                
            window.navigate('<%= ResolveUrl("~/Clients/client/Cancellation/default.aspx") %>?id=' + <%=ClientID %> + '&mid=' + <%=MatterId %>);                                                                 
        else
        ...
        {   
            if (ddlMatterSubStatus.value != hdnPrevSubStatus.value){
                ...
                switch(ddlMatterStatus.value){
                    case "1":
                    case "4":
                        ShowMessage("Settlement matter cannot be changed to Open/Completed Status");
                        ddlMatterStatus.disabled=false;
    ...
    function Record_Display(Message)
    {
        ...
        */
        ...
        function ShowResNonDeposit(matterId) {
             $(".lnksave").hide();
             var url = '<%= ResolveUrl("~/util/pop/ResolveNonDeposit.aspx") %>?mid=' + matterId + '&rand=' + Math.floor(Math.random() * 99999);
             window.dialogArguments = window;
             currentModalDialog = $('<div/>').appendTo("body").modaldialog({url: url,
                       title: "Resolve Non-deposit matter",
                       dialogArguments: window,
                       resizable: false,
                       scrollable: false,
                       ...
                       onClose: function(){
                            if ($(this).modaldialog("returnValue") == 1){
                                Record_Display("Updating changes...");
                        ...
                        <tr>
                            <td valign="top">
                                <table style="margin: 0 30 30 0; float: left; font-family: tahoma; font-size: 11px;
                                        ...
                                        <td>
                                            <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="entrytitlecell">
                                                        <asp:Label ID="lblNonDepositType" runat="server" ></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="entrytitlecell">
                                                 ...
                                                 <tr id="trBounceDate" runat="server"  >
                                                    <td class="entrytitlecell">
                                                        Bounced Date:
                                                    </td>
                                                    <td class="entrytitlecell">
                                                        <asp:Label ID="lblBouncedDate" runat="server" ></asp:Label>
                                                    </td>
                                                </tr>
                                                 <tr id="trBouncedReason" runat="server"  >
                                                    <td class="entrytitlecell">
                                                        Bounced Reason:
                                                    </td>
                                                    <td class="entrytitlecell">
                                                        <asp:Label ID="lblbounceReason" runat="server" ></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr id="trDepositId" runat="server">
                                                    <td class="entrytitlecell">
                                                        Deposit Number:
                                                    </td>
                                                    <td class="entrytitlecell">
                                                        <asp:Literal ID="ltrDepositNumber" runat="server"></asp:Literal>
                                                     </td>
                                                </tr>
                                                <tr id="trMessage" runat="server">
                                                    <td class="entrytitlecell" colspan="2">
                                                        ...
                                                        <asp:TextBox TabIndex="8" CssClass="entry" runat="server" ID="txtMatterMemo2"
                                                            Rows="5" TextMode="MultiLine" MaxLength="1000" Columns="50" Style="width: 50em"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="entrytitlecell" style="padding-left: 10; width: 250; display: none;">
