<%@ Page Language="VB" AutoEventWireup="false" CodeFile="delete.aspx.vb" Inherits="clients_client_creditors_accounts_action_delete" %>
...
function Continue()
{
    ...
    if (RequiredExist())
    {
        window.parent.dialogArguments.Record_Delete(optDo.checked, chkAddAccount.checked, chkSettlement.checked,
    ...
    <table style="width:100%;height:100%;font-family:tahoma;font-size:11px;padding:10;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td valign="top">
                ...
                <asp:Label style="font-weight:bold;" runat="server" ID="lblInfo">Are you sure you want to delete this account?  All associated
                creditor instances will also be deleted.</asp:Label>
                <br /><br />
                If you do want to delete this account, please select what you want to do with the fees that have been assessed on this account.
                <br /><br />
                <b>Fee Options:</b>
                <br />
                <br />
