<%@ Page Language="VB" AutoEventWireup="false" CodeFile="settle.aspx.vb" Inherits="clients_client_creditors_accounts_action_settle" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Settle Account</title>
    <base target="_self" />
...
//    if (RequiredExist())
//    {
        window.parent.dialogArguments.Record_Settle();
        window.close();
//    }
}
    ...
    <table style="width:100%;height:100%;font-family:tahoma;font-size:11px;padding:10;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td valign="top">
                ...
                <font style="font-weight:bold;">Are you sure you want to settle this account?</font>
                <br /><br />
                <div style="display:none;">
                    Please select the mediator associated to this settlement.
                    <br /><br /><br />
                    <b>Mediators:&nbsp;&nbsp;<asp:DropDownList style="font-family:Tahoma;font-size:11px;" runat="Server" ID="ddlAccountStatusID"></asp:DropDownList></b>
                    <br />
                    <br />
                </div>
            </td>
