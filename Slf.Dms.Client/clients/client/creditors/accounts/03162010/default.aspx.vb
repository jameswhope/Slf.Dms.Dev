...
#End Region
    ...
    Private Sub LoadAccounts()
        ...
        rpAccounts.Visible = rpAccounts.Items.Count > 0
        pnlNoAccounts.Visible = Not rpAccounts.Visible

    End Sub
    Protected Function GetBackgroundColor(ByVal removed As Object, ByVal settled As Object, ByVal verified As Object) As String
        If Not IsDBNull(removed) Then
            Return " style=""background-color:rgb(255,210,210)"" "
        ElseIf Not IsDBNull(settled) Then
        ...
        If txtSelectedAccounts.Value.Length > 0 Then
            ...
            For Each acctID As Integer In AccountIDs
                ...
                If chkAdjustRet.Checked Then
                    AccountHelper.AdjustRetainerFee(acctID, ClientID, UserID, False, SetupFeePercentage * 100, 0)
