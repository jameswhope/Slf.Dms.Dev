...
<asp:Content ID="cphBody" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    function Record_DeleteConfirm()
    {
        ...
        {
            showModalDialog("<%= ResolveUrl("~/util/pop/confirmholder.aspx?f=Record_Delete&t=Delete Accounts&m=Are you sure you want to delete this selection of accounts?") %>", window, "status:off;help:off;dialogWidth:400px;dialogHeight:300px;");
        }
    }
                                    ...
                                    <td valign="top">
                                        <table class="list" onmouseover="Grid_RowHover_Nested(this, true)" onmouseout="Grid_RowHover_Nested(this, false)" onselectstart="return false;" style="font-size: 11px; font-family: tahoma;" cellspacing="0" cellpadding="3" width="100%" border="0">
                                            ...
                                            <asp:Repeater ID="rpAccounts" runat="server">
                                                <ItemTemplate>
                                                    <a href="<%# ResolveUrl("~/clients/client/creditors/accounts/account.aspx?id=") + clientid.tostring() + "&aid=" + DataBinder.Eval(Container.DataItem, "AccountId").ToString() %>" <%#GetBackgroundColor(DataBinder.Eval(Container.DataItem, "Removed"), DataBinder.Eval(Container.DataItem, "Settled"), DataBinder.Eval(Container.DataItem, "Verified")) %>>
                                                        <tr <%#GetBackgroundColor(DataBinder.Eval(Container.DataItem, "Removed"), DataBinder.Eval(Container.DataItem, "Settled"), DataBinder.Eval(Container.DataItem, "Verified")) %>>
                                        ...
                                        <tfoot >
                                            <tr >
                                                <td colspan="<%=iif(ddlType.selectedindex=0, "7","9") %>" align="right" style="padding-top:6;background-color:white"><b>Total</b></td>
                                                <td id="tdOriginalTotal1" runat="server" align="right" style="padding-top:6;color:rgb(235,0,0);background-color:white"><%=originalTotal.ToString("c")%></td>
                                                <td align="right" style="padding-top:6;color:rgb(235,0,0);background-color:white"><%=accountTotal.ToString("c")%></td>
                                            </tr>
                                            <tr>
                                                <td colspan="<%=iif(ddlType.selectedindex=0, "7","9") %>" align="right" style="padding-top:3;background-color:white"><b>Total Active</b></td>
                                        ...
                                        <table class="entry2" style="border: 1px solid black;" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="6" style="padding:3px;border-bottom: 1px solid black; text-align: center; background-color: #DCDCDC">
                                                    Legend
                                                </td>
                                            </tr>
