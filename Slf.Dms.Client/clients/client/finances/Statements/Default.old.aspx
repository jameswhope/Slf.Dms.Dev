<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Clients/client/client.master" CodeFile="Default.aspx.vb" Inherits="Clients_client_finances_Statements_Default" Title="Client Statements" %>
                        ...
                        <td style="height:50%" valign="top"> 
                            <asp:GridView ID="grdTransactions" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Account Balance" ReadOnly="true" DataField="Account Balance">
                                        <HeaderStyle Font-Names="Tahoma" Font-Size="12px" />
                                        <ItemStyle Font-Names="Tahoma" Font-Size="11px" Height="15px" BackColor="#F0F8FF" HorizontalAlign="Right"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Balance Owed" ReadOnly="true" DataField="Balance Owed" >
                                        <HeaderStyle Font-Names="Tahoma" Font-Size="12px" />
                    ...
                    <tr>
                        <td style="height:50%;" valign="top">
                            ...
                            <asp:GridView ID="grdCreditor" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Creditor" ReadOnly="true" DataField="Creditor" >
                                    <HeaderStyle Font-Names="Tahoma" Font-Size="12px" />
                                        <ItemStyle Font-Names="Tahoma" Font-Size="11px" Height="15px"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Account Number" ReadOnly="true" DataField="AcctNo">
                                    <HeaderStyle Font-Names="Tahoma" Font-Size="12px" />
                                        <ItemStyle Font-Names="Tahoma" Font-Size="11px" Height="15px"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="*Current Balance" ReadOnly="true" DataField="Balance">
                                    <HeaderStyle Font-Names="Tahoma" Font-Size="12px" />
                                        <ItemStyle Font-Names="Tahoma" Font-Size="11px" Height="15px" BackColor="#F0F8FF" HorizontalAlign="Right"></ItemStyle>
                                    </asp:BoundField>
