<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="false"
    CodeFile="achrule.aspx.vb" Inherits="clients_client_finances_ach_achrule" Title="DMP - Client - ACH & Fee Structure" %>
...
<asp:Content ID="cphBody" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    {
        if (Record_RequiredExist() && IsValidDateRange() && !IsDisabledAccount())
        {
            // postback to save
    ...
    {
        var parts1 = txtStartDate.value.split("/");
        var date1 = new Date(parts1[0] + "/01/" + parts1[1]);
        var parts2 = txtEndDate.value.split("/");
        var date2 = new Date(parts2[0] + "/01/" + parts2[1]);
        if (date2 < date1) {
            ShowMessage("Start Date is greater than End Date"); 
            AddBorderExt(txtStartDate);
            return false;    
        } else {
            return true;
        }
    ...
    function IsDisabledAccount()
    {
        var trAcc = document.getElementById('<%=trAccountDisabled.ClientId %>');
        if (trAcc.style.display != 'none') {
            ShowMessage("Cannot save a rule if the bank account is Disabled."); 
            return true;
        }  else{
            return false;
        }
                    ...
                    <a runat="server" class="lnk" style="color: #666666;" href="~/clients">Clients</a>&nbsp;>&nbsp;<a
                        id="lnkClient" runat="server" class="lnk" style="color: #666666;"></a>&nbsp;>&nbsp;<a
                            id="lnkFinances" runat="server" class="lnk" style="color: #666666;">Finances</a>&nbsp;>&nbsp;<a
                                id="lnkACH" runat="server" class="lnk" style="color: #666666;">ACH</a>&nbsp;>&nbsp;<asp:Label
                                    runat="server" ID="lblACHRule"></asp:Label>
                </td>
            </tr>
            <tr>
                <td valign="top">
                                                    ...
                                                    <td>
                                                        <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <cc1:InputMask validate="IsValidDateTimeMY(Input.value);" caption="Start Date" required="true"
                                                                        TabIndex="18" CssClass="entry" ID="txtStartDate" runat="server" Mask="nn/nnnn"></cc1:InputMask>
                                                                </td>
                                                                <td style="width: 55;">
                                                                    <a class="lnk" runat="server" id="lnkSetToNowStart" href="#" onclick="javascript:SetToNow(this.parentElement.previousSibling.childNodes(0));">
                                                                        Set To Now</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <cc1:InputMask validate="IsValidDateTimeMY(Input.value);" caption="End Date" required="true"
                                                                        TabIndex="18" CssClass="entry" ID="txtEndDate" runat="server" Mask="nn/nnnn"></cc1:InputMask>
                                                                </td>
                                                                <td style="width: 55;">
                                                                    <a class="lnk" runat="server" id="lnkSetToNowEnd" href="#" onclick="javascript:SetToNow(this.parentElement.previousSibling.childNodes(0));">
                                                                        Set To Now</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <td>
                                                        <table style="table-layout: fixed; font-family: tahoma; font-size: 11px; width: 100%;"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlBankName" class="entry" runat="server" AutoPostBack="True"
                                                                        Width="100%" Style="display: none;" AppendDataBoundItems="false">
                                                                        <asp:ListItem Text="(Select Bank)" Value="select" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox MaxLength="9" validate="IsValidTextLength(Input.value, 9, 9);" caption="Bank Routing Number" AutoPostBack="true"
                                                                        required="true" TabIndex="5" CssClass="entry" ID="txtBankRoutingNumber" runat="server"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="entrytitlecell">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox MaxLength="255" validate="" caption="Bank Account Number" required="true"
                                                                        TabIndex="5" CssClass="entry" ID="txtBankAccountNumber" runat="server"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="entrytitlecell">
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList class="entry" ID="cboBankType" runat="server" Style="font-size: 11px">
                                                                        <asp:ListItem Value="C" Text="Checking" Selected="True"></asp:ListItem>
                                                                        <asp:ListItem Value="S" Text="Savings"></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr id="trAccountDisabled" style="display: none;" runat="server"  >
                                                                <td colspan="2" class="entry" style="color:Red" align="left" >This bank account is disabled</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
