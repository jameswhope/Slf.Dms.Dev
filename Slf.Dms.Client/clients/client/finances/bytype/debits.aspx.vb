...
Partial Class clients_client_finances_bytype_debits
...
#End Region
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        tsMain.TabPages(5).Selected = True
    ...
    Private Sub LoadTabStrips()
        ...
        tsMain.TabPages.Add(New Slf.Dms.Controls.TabPage("<span id=""tabCaption5"">Debits</span>", dvPanel0.ClientID))
    ...
    End Function
    Private Sub Requery()
        Using cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_GetTransactionByType_Debits")
