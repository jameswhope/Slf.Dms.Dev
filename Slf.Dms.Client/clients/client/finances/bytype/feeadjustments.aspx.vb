...
Partial Class clients_client_finances_bytype_feeadjustments
...
#End Region
    ...
    Private Sub SetRollups()
        ...
        If Master.UserEdit Then
            ...
            CommonTasks.Add("<a style=""color:rgb(51,118,171);"" class=""lnk"" href=""#"" onclick=""Record_AddCall();return false;""><img style=""margin-right:8px;"" border=""0"" runat=""server"" src=""" & ResolveUrl("~/images/16x16_phone2.png") & """ align=""absmiddle""/>Phone call</a>")
            CommonTasks.Add("<a style=""color:rgb(51,118,171);"" class=""lnk"" href=""#"" onclick=""Record_Email();return false;""><img style=""margin-right:8px;"" border=""0"" runat=""server"" src=""" & ResolveUrl("~/images/16x16_email.png") & """ align=""absmiddle""/>Email this client</a>")
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        tsMain.TabPages(4).Selected = True
    ...
    Private Sub LoadTabStrips()
        ...
        tsMain.TabPages.Add(New Slf.Dms.Controls.TabPage("<span id=""tabCaption4"">Fee&nbsp;Adjustments</span>", dvPanel0.ClientID))
    ...
    End Function
    Private Sub Requery()
        Using cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_GetTransactionByType_FeeAdjustments")
