<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="false" CodeFile="debits.aspx.vb" Inherits="clients_client_finances_bytype_debits" Title="DMP - Client - Debits" %>
            ...
            <td style="height:100%;" valign="top">
                ...
                <div id="dvPanel0" runat="server">
                    <table style="margin-top:15;background-color:#f3f3f3;font-family:tahoma;font-size:11px;width:100%;" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td style="padding:5 7 5 7;color:rgb(50,112,163);">Debits</td>
                    ...
                    <asp:panel runat="server" id="pnlNone" style="text-align:center;padding:20 5 5 5;">This client has no debits.</asp:panel>
                </div>
            </td>
        </tr>
    </table>
