...
Partial Class clients_client_finances_bytype_adddeb
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not qs Is Nothing Then
            ...
            If Not IsPostBack Then
                ...
                LoadEntryTypes(cboEntryTypeID, "-- Select a debit --", 0, "Fee = 0 AND Type = 'Debit'")
    ...
    Private Sub SetupCommonTasks()
        ...
        If Master.UserEdit Then
            ...
            If Permission.UserEdit(Master.IsMy) Then
                ...
                CommonTasks.Add("<a style=""color:rgb(51,118,171);"" class=""lnk"" href=""#"" onclick=""Record_Save();return false;""><img style=""margin-right:8px;"" border=""0"" runat=""server"" src=""" & ResolveUrl("~/images/16x16_save.png") & """ align=""absmiddle""/>Save new debit</a>")
            Else
    ...
    Private Sub Close()
        ...
        While i >= 0 AndAlso (Navigator.Pages(i).Url.IndexOf("bytype/add.aspx") = -1 _
            Or Navigator.Pages(i).Url.IndexOf("bytype/adddeb.aspx") = -1) 'not found
    ...
    Protected Sub lnkSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkSave.Click
        ...
        RegisterID = RegisterHelper.InsertDebit(ClientID, AccountID, DataHelper.Nz_date(txtTransactionDate.Text), _
            txtCheckNumber.Text, txtDescription.Text, Amount, MediatorID, DataHelper.Nz_int(cboEntryTypeID.SelectedValue), _
            UserID)
