<%@ Page Language="VB" AutoEventWireup="false" CodeFile="clear.aspx.vb" Inherits="clients_client_finances_bytype_action_clear" %>
<%@ Register Assembly="AssistedSolutions.WebControls.InputMask" Namespace="AssistedSolutions.WebControls" TagPrefix="cc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Issue A Clear</title>
    <base target="_self" />
...
function Continue()
{
    if (RequiredExist())
    {
        window.parent.dialogArguments.Record_Clear(imClear.value);
        window.close();
    }
}
function RequiredExist()
{
    ...
    if (imClear.value.length == 0)
    {
        ShowMessage("The Clear Date is required.");
        AddBorder(imClear);
        return false;
    }
    else
    {
        if (!IsValidDateTime(imClear.value))
        {
            ShowMessage("The Clear Date is invalid.  Please enter a different value.");
            AddBorder(imClear);
            return false;
        }
    }
...
function LoadControls()
{
    if (imClear == null)
    {
        imClear = document.getElementById("<%= imClear.ClientID() %>");
    }
}
function SetToNow()
{
    ...
    {
        imClear.value = Functoid_Date_FormatDateTimeMedium(new Date(), "/");
    }
}
    ...
    <table style="width:100%;height:100%;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td valign="top" style="height:100%;font-family:tahoma;font-size:11px;">
                ...
                <br />
                <b>Are you sure you want to issue a clear on this deposit?</b>
                <br />
                <br />
                As soon as this deposit is cleared, the associated funds will immediately become available.
                <br />
                <br />
                <table style="font-family:tahoma;font-size:11px;width:275;" border="0" cellpadding="0" cellspacing="7">
                    ...
                    <tr>
                        <td>Clear Date:</td>
                        <td><cc1:InputMask cssclass="entry" ID="imClear" runat="server" Mask="nn/nn/nnnn nn:nn aa"></cc1:InputMask></td>
