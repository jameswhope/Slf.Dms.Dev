<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="false" CodeFile="feeadjustments.aspx.vb" Inherits="clients_client_finances_bytype_feeadjustments" title="DMP - Client - Fee Adjustments" %>
    ...
    <table id="tblBody" style="font-family: tahoma; font-size: 11px; width: 100%; height: 100%;" border="0" cellspacing="15">
        <tr>
            <td valign="top" style="color: #666666;">
                <a id="A1" runat="server" class="lnk" style="color: #666666;" href="~/clients">Clients</a>&nbsp;>&nbsp;<a id="lnkClient" runat="server" class="lnk" style="color: #666666;"></a>&nbsp;>&nbsp;Finances&nbsp;>&nbsp;Transactions By Type
            </td>
        </tr>
        <tr>
            <td style="height:100%;" valign="top">
                ...
                <div id="dvPanel0" runat="server">
                    ...
                    <table onselectstart="return false;" style="font-size:11px;font-family:tahoma;" cellspacing="0" cellpadding="3" width="100%" border="0">
                        <tr>
                            <td class="headItem" style="width:22;" align="center"><img id="Img1" runat="server" src="~/images/16x16_icon.png" border="0" align="absmiddle"/></td>
                            <td class="headItem">Date<img id="Img2" align="absmiddle" style="margin-left:5;" runat="server" border="0" src="~/images/sort-asc.png" /></td>
                            ...
                            <itemtemplate>
                                ...
                                <tr IsMainRow="true">
                                    <td onmouseover="RowHover(this, true);" onmouseout="RowHover(this, false);" style="width:22;" class="listItem" align="center">
                                        <img id="Img3" runat="server" src="~/images/16x16_cheque.png" border="0"/>
                                    </td>
                                    ...
                                    <td onmouseover="RowHover(this, true);" onmouseout="RowHover(this, false);" class="listItem" >
                                        <%#DataBinder.Eval(Container.DataItem, "adjustedregisterentrytypename")%>&nbsp;
                                       <%-- <%#DataBinder.Eval(Container.DataItem, "AdjustedReason")%>&nbsp;--%>
                                    </td>
                                </tr>
                                </a>
                            </itemtemplate>
