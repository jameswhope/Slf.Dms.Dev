...
Partial Class clients_client_finances_bytype_credits
...
#End Region
    ...
    Private Sub LoadTabStrips()
        ...
        tsMain.TabPages.Add(New Slf.Dms.Controls.TabPage("<span id=""tabCaption2"">Credits</span>", dvPanel0.ClientID))
    ...
    End Function
    Private Sub Requery()
        Using cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_GetTransactionByType_Credits")
