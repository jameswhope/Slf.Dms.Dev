<%@ Page Language="VB" MasterPageFile="~/clients/client/client.master" AutoEventWireup="false" CodeFile="addf.aspx.vb" Inherits="clients_client_finances_bytype_addf" title="DMP - Client - Add Fee" %>
...
<body style="background-image:url(<%= ResolveUrl("~/images/back.bmp") %>); background-position:left top; background-repeat:repeat-x;">
    ...
    function LoadControls()
    {
        if (cboEntryTypeID == null)
        {
            ...
            cboFeeMonth = document.getElementById("<%= cboFeeMonth.ClientID %>");
            cboFeeYear = document.getElementById("<%= cboFeeYear.ClientID %>");
            ...
            trFeeMonthYear = document.getElementById("<%= trFeeMonthYear.ClientID %>");
    ...
    function Record_RequiredExist()
    {
        ...
        RemoveBorder(cboFeeMonth);
        RemoveBorder(cboFeeYear);
	    ...
	    {
            ShowMessage("The Assessment Date is required.");
	    ...
	    else
	    {
	        ...
	        {
                ShowMessage("The Assessment Date you entered is invalid.  Please enter a new value.");
                AddBorder(txtTransactionDate);
                return false;
	        }
	    }
        ...
        {
            ShowMessage("The Fee Type is required.");
            AddBorder(cboEntryTypeID);
            return false;
        }

        // fee month/year
        if (trFeeMonthYear.style.display == "inline")
        {
            if (cboFeeMonth.selectedIndex == -1 || cboFeeMonth.options[cboFeeMonth.selectedIndex].value <= 0)
            {
                ShowMessage("Based on the Fee Type you selected, the Fee Month is required.");
                AddBorder(cboFeeMonth);
                return false;
            }

            if (cboFeeYear.selectedIndex == -1 || cboFeeYear.options[cboFeeYear.selectedIndex].value <= 0)
            {
                ShowMessage("Based on the Fee Type you selected, the Fee Year is required.");
                AddBorder(cboFeeYear);
                return false;
            }
        }
        ...
        if (trAccountID.style.display == "inline")
        {
            ...
            {
                ShowMessage("Based on the Fee Type you selected, the Account is required.");
        ...
        if (trMediatorID.style.display == "inline")
        {
            ...
            {
                ShowMessage("Based on the Fee Type you selected, the Mediator is required.");
    ...
    function cboEntryTypeID_OnChange(cbo)
    {
	    ...
	    if (cbo.selectedIndex != -1 && cbo.options[cbo.selectedIndex].value == "1") //Maintenance Fee
	    {
	        trFeeMonthYear.style.display = "inline";
	        trAccountID.style.display = "none";
	        trMediatorID.style.display = "none";
	    }
	    else if (cbo.selectedIndex != -1 && cbo.options[cbo.selectedIndex].value == "2") //Retainer Fee
	    {
	        trFeeMonthYear.style.display = "none";
	        trAccountID.style.display = "inline";
	        trMediatorID.style.display = "none";
	    }
	    else if (cbo.selectedIndex != -1 && cbo.options[cbo.selectedIndex].value == "4") //Settlement Fee
	    {
	        trFeeMonthYear.style.display = "none";
	        trAccountID.style.display = "inline";
	        trMediatorID.style.display = "inline";
	    }
	    else if (cbo.selectedIndex != -1 && cbo.options[cbo.selectedIndex].value == "19") //additional account fee
	    {
	        trFeeMonthYear.style.display = "none";
	        trAccountID.style.display = "inline";
	        trMediatorID.style.display = "none";
    ...
    <table runat="server" id="tblBody" style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="0" cellspacing="15">
        <tr>
            <td style="color: #666666;font-size:13px;"><a id="lnkClient" runat="server" class="lnk" style="font-size:11px;color:#666666;"></a>&nbsp;>&nbsp;<a id="lnkFinanceRegister" runat="server" class="lnk" style="color: #666666;font-size:13px;">Finances</a>&nbsp;>&nbsp;Assess New Fee</td>
        </tr>
        <tr>
            <td valign="top">
                    ...
                    <tr>
                        <td style="width:50%;" valign="top">
                            <table style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="5" cellspacing="0">
                                ...
                                <tr>
                                    <td class="entrytitlecell" nowrap="true">Fee&nbsp;Type:</td>
                                    <td><asp:DropDownList CssClass="entry" runat="server" id="cboEntryTypeID"></asp:DropDownList></td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr id="trFeeMonthYear" runat="server" style="display:none;">
                                    <td class="entrytitlecell" nowrap="true">Fee&nbsp;Month/Year:</td>
                                    <td>
                                        <table style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width:50%;padding-right:5;"><asp:DropDownList CssClass="entry" runat="server" id="cboFeeMonth"></asp:DropDownList></td>
                                                <td style="width:50%;"><asp:DropDownList CssClass="entry" runat="server" id="cboFeeYear"></asp:DropDownList></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td class="entrytitlecell" nowrap="true">Assessment&nbsp;Date:</td>
                                ...
                                <tr>
                                    <td class="entrytitlecell" nowrap="true">Fee&nbsp;Amount:</td>
