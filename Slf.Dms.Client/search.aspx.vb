...
#Region "Requery"
    Private Sub Requery()
        ...
        pnlSearchNotes.Visible = False
        pnlNoSearchNotes.Visible = True

        pnlSearchCalls.Visible = False
        pnlNoSearchCalls.Visible = True
    ...
    Private Function RequeryClients(ByVal Values() As String) As Integer
        ...
        DatabaseHelper.AddParameter(cmd, "Orderby", "order by tblclientsearch.name")
        ...
        Try
            ...
            While rd.Read()
                ...
                ClientSearches.Add(New ClientSearch(DatabaseHelper.Peel_int(rd, "ClientID"), _
                    ...
                    DatabaseHelper.Peel_string(rd, "ContactNumber"), _
