<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default_nomaster.aspx.vb"
    Inherits="research_reports_financial_accounting_Default_nomaster" %>
...
<script type="text/javascript">
	function SetDates(ddl)
	{
        ...
        <ajaxToolkit:ToolkitScriptManager ID="sm1" runat="server" AsyncPostBackTimeout="240" />
                                ...
                                <tr>
                                    <td style="width: 100%; height: 100%" valign="top">
                                        <div style="overflow: auto; width: 100%; height: 600px">
                                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Size="8pt" Width="97%"
