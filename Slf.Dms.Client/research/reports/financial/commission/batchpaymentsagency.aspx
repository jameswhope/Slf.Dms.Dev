<%@ Page Language="VB" MasterPageFile="~/research/reports/financial/commission/commission.master" AutoEventWireup="false" CodeFile="batchpaymentsagency.aspx.vb" Inherits="research_reports_financial_commission_batchpaymentsagency" Title="DMP - Commission" %>
...
function RowClick(tr, CommBatch)
{
    //unselect last row
...
function Export()
{
    window.open("<%=ResolveUrl("~/research/reports/financial/commission/batchdetailxls.ashx") %>");
}
...
<body scroll="no" onload="SetKeyPress();">
    <table style="font-family:tahoma;font-size:11px;width:100%;height:100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <td style="width:100%;">
                            <table style="height:25;background-image:url(<%= ResolveUrl("~/images/grid_top_back.bmp") %>);background-repeat:repeat-x;background-position:left top;background-color:rgb(232,227,218);font-family:tahoma;font-size:11px;width:100%;" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td nowrap="true" style="width:5px;">&nbsp;</td>
                                    <td nowrap="true"><asp:DropDownList id="ddlCommRec" runat="server" style="font-family:tahoma;font-size:11px;width:100px;" Visible="false"></asp:DropDownList></td>
                                    <td nowrap="true" style="width:5px;">&nbsp;</td>
        ...
        <tr>
            <td valign="top" style="width:375px;height:100%;border-left:solid 1px rgb(172,168,153);background-color:#fcfcfc">
                                    ...
                                    <table class="list" onmouseover="RowHover(this, true)" onmouseout="RowHover(this, false)" onselectstart="return false;" cellspacing="0" cellpadding="3" width="100%" border="0">
                                        ...
                                        <tbody>
                                            <asp:repeater id="rpBatches" runat="server">
                                                <itemtemplate>
                                                    <a href="#" onclick="RowClick(this.childNodes(0), '<%#CType(Container.DataItem, BatchEntry).CommBatchID %>');">
                                                        <tr>
                                                            <td style="width:22" align="center">
                                                                <img runat="server" src="~/images/16x16_cheque.png" border="0"/>
                                                            </td>
                                                            <td nowrap="true">
                                                                <%#GetBatchNumber(CType(Container.DataItem, BatchEntry).CommBatchId)%>
                                                            </td>
                                                            <td nowrap="true" align="center">
	                                                            <%#CType(Container.DataItem, BatchEntry).BatchDate.ToString("MMM d, yyyy")%>
	                                                        </td>
	                                                        <td align="right">
