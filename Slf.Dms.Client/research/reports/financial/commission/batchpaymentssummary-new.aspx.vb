...
Partial Class research_reports_financial_commission_batchpaymentssummary_new
    Inherits System.Web.UI.Page

    Private UserID As Integer
    Private NetPayments As Double

    Protected Sub research_reports_financial_commission_batchpaymentssummary_new_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Protected Sub lnkRequery_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkRequery.Click
        Using cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_ReportGetCommissionBatchPaymentsSummary_new")
            Using cmd.Connection
                Dim da As SqlDataAdapter
                Dim ds As New DataSet
                cmd.CommandTimeout = 180
                DatabaseHelper.AddParameter(cmd, "date1", txtTransDate1.Text)
                DatabaseHelper.AddParameter(cmd, "date2", txtTransDate2.Text & " 23:59")
