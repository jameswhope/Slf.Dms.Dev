...
<head runat="server">
    ...
    <script language="javascript">
        ...
        function RowClick(tr, ClientID)
        {
            ...
            document.getElementById("ifrmPerson").src = "persondetail.aspx?commissionbatchids=<%= Request.QueryString("commissionbatchids") %>&commrecid=<%= Request.QueryString("commrecid") %>&currentclientidentry=" + ClientID;
