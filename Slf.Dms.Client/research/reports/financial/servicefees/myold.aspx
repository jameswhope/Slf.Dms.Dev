<%@ Page Language="VB" MasterPageFile="~/research/reports/financial/servicefees/servicefees.master" AutoEventWireup="false" CodeFile="myold.aspx.vb" Inherits="research_reports_financial_servicefees_myold" title="DMP - Service Fees" %>
...
<script type="text/javascript">
    ...
    function Body_OnLoad()
    {
        ...
        if (InstallAcrobat.Installed)
        {
            ...
            ifrmReport.src = "<%=ResolveUrl("~/reports/engine/container.ashx?rpt=report_servicefee_my&f=pdf&d=False") %>";
        }
        else
        {
