...
Partial Class research_reports_financial_servicefees_RefundReport
...
#End Region
   ...
   Protected Sub lnkView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkView.Click
      ...
      strSQL = RefundHelper.CreateBigTSQL(StartDate, EndDate)

      'Setup the report basics and paths.
      Try
         ReportPath = "RefundReport.rdl"
         'set viewer mode
         Me.ReportViewer1.Reset()
         Me.ReportViewer1.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local
         ...
         Me.ReportViewer1.LocalReport.ReportPath = "research\reports\financial\servicefees\" & ReportPath
         ...
         dsA = RefundHelper.getReportDataSet(strSQL, "Refunds")
