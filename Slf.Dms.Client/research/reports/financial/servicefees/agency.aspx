<%@ Page EnableEventValidation="false" Language="VB" MasterPageFile="~/research/reports/financial/servicefees/servicefees.master" AutoEventWireup="false" CodeFile="agency.aspx.vb" Inherits="research_reports_financial_servicefees_agency" Title="DMP - Service Fees" %>
<%@ Register Assembly="AssistedSolutions.WebControls.InputMask" Namespace="AssistedSolutions.WebControls" TagPrefix="cc1" %>
<%@ Register TagPrefix="asi" Namespace="Slf.Dms.Controls" Assembly="Slf.Dms.Controls" %>
<asp:Content ID="cntBody" ContentPlaceHolderID="cphBodyAgency" runat="Server">
...
<ItemTemplate><a class="lnk" href="<%=ResolveUrl("~/research/reports/financial/servicefees/agencypayment.aspx") %>?id=<%#CType(Container.DataItem, Payment).ClientId%>&rpid=<%#CType(Container.DataItem, Payment).RegisterPaymentID%>">
...
<ItemTemplate><a class="lnk" href="<%=ResolveUrl("~/research/reports/financial/servicefees/agencyregister.aspx") %>?id=<%#CType(Container.DataItem, Payment).ClientId%>&rid=<%#CType(Container.DataItem, Payment).RegisterID%>">
