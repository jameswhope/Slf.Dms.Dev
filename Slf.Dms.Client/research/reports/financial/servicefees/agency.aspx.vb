...
Partial Class research_reports_financial_servicefees_agency
...
#Region "Sorting"
    ...
    Protected Sub lnkResort_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkResort.Click
        ...
        If txtSortFieldA.Text = SortFieldA Then
            'toggle sort order
            If SortOrderA = "ASC" Then
                SortOrderA = "DESC"
            Else
                SortOrderA = "ASC"
            End If
        ...
        If txtSortFieldB.Text = SortFieldB Then
            'toggle sort order
            If SortOrderB = "ASC" Then
                SortOrderB = "DESC"
            Else
                SortOrderB = "ASC"
            End If
        ...
        qsb("SortFieldA") = SortFieldA
        qsb("SortOrderA") = SortOrderA
        qsb("SortFieldB") = SortFieldB
        qsb("SortOrderB") = SortOrderB
...
#Region "Events"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        SortFieldA = GetQueryString("SortFieldA", "tdLastName")
        SortOrderA = GetQueryString("SortOrderA", "ASC")
        SortFieldB = GetQueryString("SortFieldB", "tdLastName2")
        SortOrderB = GetQueryString("SortOrderB", "ASC")

        If Not IsPostBack Then
            PopulateDates()

            If Not String.IsNullOrEmpty(qs("y")) Then
                ListHelper.SetSelected(ddlDay, Integer.Parse(qs("d")))
                ListHelper.SetSelected(ddlMonth, Integer.Parse(qs("m")))
