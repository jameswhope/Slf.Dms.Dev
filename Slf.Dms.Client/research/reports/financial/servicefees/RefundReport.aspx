<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="RefundReport.aspx.vb" Inherits="research_reports_financial_servicefees_RefundReport" title="Refund Report" EnableViewState="true"%>
...
<asp:Content ID="cphBody" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:UpdatePanel ID="ud1" runat="server">
        ...
        <asp:Label ID="lblMsg" runat="server" Font-Size="16" Font-Names="Tahoma" Text="Refund Reporting" ></asp:Label>
        </table>
