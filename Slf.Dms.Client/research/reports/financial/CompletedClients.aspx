<%@ Page Title="" Language="VB" MasterPageFile="~/research/reports/reports.master" AutoEventWireup="false" CodeFile="CompletedClients.aspx.vb" Inherits="research_reports_clients_CompletedClients" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" Runat="Server">
            ...
            <td style="color: #666666; padding-bottom: 15px">
                <a id="A1" runat="server" class="lnk" style="color: #666666;" href="~/research">Research</a>&nbsp;>&nbsp;<a id="A2"
                    runat="server" class="lnk" style="color: #666666;" href="~/research/reports">Reports</a>&nbsp;>&nbsp;<a id="A3"
                        runat="server" class="lnk" style="color: #666666;" href="~/research/reports/clients">Financial</a>&nbsp;>&nbsp;Completed Clients With Positive CDA
            </td>
        </tr>
    </table>
    <table width="100%">
    ...
    <table width="100%">
          <tr>
            <asp:GridView ID="gvClients" runat="server" AllowPaging="false" AutoGenerateColumns="false" BorderWidth="1" CellPadding="5" >
                <Columns>
                    ...
                    <asp:BoundField DataField="DepositAmount" HeaderText="Deposit Amount" DataFormatString="{0:C}" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField DataField="DepositGTPFO" HeaderText="Deposit GT PFO" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center"  />
                    <asp:BoundField DataField="LawFirm" HeaderText="Law Firm" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"  />
                    <asp:BoundField DataField="DepositMethod" HeaderText="Deposit Method" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" />
                </Columns>
            </asp:GridView>
        </tr>
    </table>
