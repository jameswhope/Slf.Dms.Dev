<%@ Page Language="VB" MasterPageFile="~/research/research.master" AutoEventWireup="false" CodeFile="myassignments_bycreditor.aspx.vb" Inherits="research_reports_clients_mediation_myassignments_bycreditor" title="DMP - Research" %>
...
{
    window.open("<%=ResolveUrl("~/reports/interface/frame.aspx")%>?rpt=" + "report_clients_accountsoverpercentage_bycreditor", "winreport_clients_myassignments", "width=850,height=600,left=75,top=50,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes");
}
                    ...
                    <td valign="top" style="height:100%;width:100%">
                        <div style="width:100%;height:100%;overflow:auto;padding: 0 15 15 15">
                            ...
                            <table class="list" onmouseover="Hover(this,true)" onmouseout="Hover(this,false)" style="width:100%;font-family:tahoma;font-size:11px;" cellspacing="0">
                                <colgroup>
                                    <col style="border-left:solid 1px silver" align="center"/>
                                    <col />
                                    <col />
                                    <col style="background-color:rgb(255,255,210)" align="center"/>
                                    <col style="background-color:rgb(255,255,210)" />
                                    <col style="background-color:rgb(255,255,210)" />
                                    <col style="background-color:rgb(255,255,210)" />
                                    <col style="background-color:rgb(255,255,210)" align="right" style="padding-right:5px"/>
                                    <col style="background-color:rgb(221,255,221)" style="padding-left:5px"/>
                                    <col style="background-color:rgb(221,255,221)" align="right"/>
                                    <col style="background-color:rgb(221,255,221)" align="right"/>
                                </colgroup>
                                <thead>
                                    ...
                                    <tr style="height:20px">
                                        <th colspan="3" style="height:20px;background-color:rgb(255,255,255)"></th>
                                        <th nowrap="true" colspan="5" style="height:20px;background-color:rgb(255,255,210);border-left:solid 1px silver;border-top:solid 1px silver;border-right:solid 1px silver" align="center">Clients</th>
                                        <th nowrap="true" colspan="3" style="height:20px;background-color:rgb(221,255,221);border-left:solid 1px silver;border-top:solid 1px silver;border-right:solid 1px silver" align="center">Creditor Accounts</th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th onclick="Sort(this)" runat="server" id="tdCreditorName" nowrap align="left" style="cursor:pointer" >Creditor</th>
                                        <th onclick="Sort(this)" runat="server" id="tdCreditorPhone" nowrap align="left" style="cursor:pointer" >Phone</th>
                                        
                                        <th nowrap="true" style="width:22;height:22" align="center"><img runat="server" src="~/images/16x16_icon.png" border="0" align="absmiddle"/></th>
                                        <th runat="server" id="tdAccountNumber" nowrap align="left" >Acct No.</th>
                                        <th runat="server" id="tdLastName" nowrap align="left" >Full Name</th>
                                        <th runat="server" id="tdSSN"  nowrap align="left" >SSN</th>
                                        <th runat="server" id="tdSDABalance" nowrap align="right" >SDA Bal</th>
                                ...
                                <tbody>
                                    <asp:repeater id="rpResults" runat="server"><itemtemplate>
										<%#GetClientInfo(CType(Container.DataItem, Creditor))%>
