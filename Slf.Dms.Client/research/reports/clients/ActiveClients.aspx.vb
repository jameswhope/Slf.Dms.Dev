...
Partial Class research_reports_clients_ActiveClients
    ...
    Private Function GetReportData(ByVal CompanyIds As String, ByVal AgencyIds As String) As DataTable
        ...
        Return SqlHelper.GetDataTable("stp_GetActiveClients_Report", CommandType.StoredProcedure, params.ToArray)
    End Function
                  ...
                  New XElement("table", _
                      New XElement("thead", _
                          New XElement("tr", _
                              ...
                              New XElement("th", "SDA Bal."), _
                              New XElement("th", "PFO Bal."), _
                              New XElement("th", "Maint. Fee"), _
                              New XElement("th", "Aval. Bal."))), _
                      New XElement("tbody", _
                          ...
                          Select New XElement("tr", _
                                  ...
                                  New XElement("td", r("File #").ToString()), _
                                  New XElement("td", String.Format("{0:c}", r("SDA Bal"))), _
                                  New XElement("td", String.Format("{0:c}", r("PFO Bal"))), _
                                  New XElement("td", String.Format("{0:c}", r("Maint Fee"))), _
                                  New XElement("td", String.Format("{0:c}", r("Aval Bal")))))))
