<%@ Page Title="" Language="VB" MasterPageFile="~/research/reports/clients/clients.master" AutoEventWireup="false" CodeFile="ActiveClients.aspx.vb" Inherits="research_reports_clients_ActiveClients" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <asp:UpdatePanel ID="ud1" runat="server" >
        <ContentTemplate>
            <asp:GridView ID="grdReport" runat="server" AutoGenerateColumns="False" AllowSorting="true" DataKeyNames="ClientId" EmptyDataText="No data to display." CssClass="grdReport" AllowPaging="True" PageSize="200" PagerStyle-HorizontalAlign="center"   >
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SDA Bal" HeaderText= "SDA Bal. " DataFormatString="{0:c}" ItemStyle-CssClass="moneyCell" SortExpression="[SDA Bal]"/>
                    <asp:BoundField DataField="PFO Bal" HeaderText= "PFO Bal. " DataFormatString="{0:c}" ItemStyle-CssClass="moneyCell" SortExpression="[PFO Bal]"/>
                    <asp:BoundField DataField="Maint Fee" HeaderText= "Maint. Fee. " DataFormatString="{0:c}" ItemStyle-CssClass="moneyCell" SortExpression="[Maint Fee]"/>
                    <asp:BoundField DataField="Aval Bal" HeaderText= "Aval. Bal. " DataFormatString="{0:c}"  ItemStyle-CssClass="moneyCell" SortExpression="[Aval Bal]" />
                </Columns>
            </asp:GridView> 
