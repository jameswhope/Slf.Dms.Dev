...
Partial Class research_metrics_metrics
    Inherits SideTabMasterPage

    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        AddControl(pnlBody, c, "Research-Metrics")
        AddControl(tdTabFinancial, c, "Research-Metrics-Financial")
        AddControl(tdTabClients, c, "Research-Metrics-Clients")
    End Sub
