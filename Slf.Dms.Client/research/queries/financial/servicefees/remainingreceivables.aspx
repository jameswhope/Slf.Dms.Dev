<%@ Page Language="VB" MasterPageFile="~/research/queries/financial/servicefees/servicefees.master" AutoEventWireup="false" CodeFile="remainingreceivables.aspx.vb" Inherits="research_queries_financial_servicefees_remainingreceivables" title="DMP - Service Fees" %>
...
{
    window.open("<%=ResolveUrl("~/reports/interface/frame.aspx")%>?rpt=" + "query_servicefee_remainingreceivables", "winreport_servicefee_remainingreceivables", "width=850,height=600,left=75,top=50,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes");
}
</script>
<style type="text/css">
thead th{
        ...
        <td valign="top" id="tdFilter" runat="server">
            <div style="padding:15 15 15 15;overflow:auto;height:100%;width:175;">
                <table style="font-family:tahoma;font-size:11px;width:100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td style="padding-bottom:10;"><b>Fee Date Period</b></td>
                    </tr>
                    <tr>
                        <td>
