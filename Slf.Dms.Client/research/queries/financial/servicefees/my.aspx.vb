...
Partial Class research_queries_financial_servicefees_my
...
#Region "Util"
    ...
    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        AddControl(pnlBody, c, "Research-Queries-Financial-Service Fees-My Service Fees")
    End Sub
#End Region
#Region "Query"
    ...
    Private Sub Requery(ByVal Reset As Boolean)
        ...
        Session("rptcmd_query_servicefee_my_payments") = cmd
