<%@ Page Language="VB" MasterPageFile="~/research/queries/financial/accounting/accounting.master" AutoEventWireup="false" CodeFile="clearingaccount.aspx.vb" Inherits="research_queries_financial_transfer_clearingaccount" title="DMP - Service Fees" %>
...
{
    window.open("<%=ResolveUrl("~/reports/interface/frame.aspx")%>?rpt=" + "clearingaccounttransactions", "winrptservicefeereport", "width=850,height=600,left=75,top=50,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes");
}
</script>
<style>
