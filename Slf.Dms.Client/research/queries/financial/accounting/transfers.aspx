<%@ Page Title="" Language="VB" MasterPageFile="~/research/queries/financial/accounting/accounting.master" AutoEventWireup="false" CodeFile="transfers.aspx.vb" Inherits="research_queries_financial_accounting_transfers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="Server">
    <asp:PlaceHolder ID="pnlBody" runat="server">
        ...
        <table runat="server" id="tblBody" style="font-family: tahoma; font-size: 11px; width: 100%;
                                ...
                                <table style="height: 25; background-image: url(<%= ResolveUrl("~/images/grid_top_back.bmp") %>);
                                    ...
                                    <tr>
                                        <td nowrap="nowrap" valign="center" style="padding-left:5px">
                                            From:
                                            <asp:DropDownList ID="ddlFromCompany" runat="server" CssClass="entry2">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 5;">
                                            &nbsp;
                                        ...
                                        <td nowrap="nowrap" valign="center" style="padding-left:5px">
                                            To:
                                            <asp:DropDownList ID="ddlToCompany" runat="server" CssClass="entry2">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 5;">
                                            &nbsp;
                                        </td>
                                        <td nowrap="nowrap" valign="center" style="padding:5px">
                                            Transferred between
                                        </td>
                                        <td>
                                            <igsch:WebDateChooser ID="txtFromDate" runat="server" Width="78px" Height="10px" Font-Names="tahoma" Font-Size="11px" DropButton-Style-Height="17px" CalendarLayout-CalendarStyle-Font-Names="tahoma" CalendarLayout-CalendarStyle-Font-Size="11px">
                                        ...
                                        <td>
                                            <igsch:WebDateChooser ID="txtToDate" runat="server" Width="78px" Height="10px" Font-Names="tahoma" Font-Size="11px" DropButton-Style-Height="17px" CalendarLayout-CalendarStyle-Font-Names="tahoma" CalendarLayout-CalendarStyle-Font-Size="11px">
                                            </igsch:WebDateChooser>
                                        </td>
                                        <td style="width: 10;">
                                            &nbsp;
            ...
            <tr>
                <td>
                    <h4 style="padding:5px">Client Bank Transfers</h3>
                </td>
            </tr>
            <tr>
