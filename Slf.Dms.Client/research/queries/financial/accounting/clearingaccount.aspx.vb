...
Partial Class research_queries_financial_transfer_clearingaccount
...
#Region "Query"
    ...
    Private Sub Requery(ByVal Reset As Boolean)
        ...
        Dim cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_QueryGetClearingAccountTransactions")
        AddStdParams(cmd)
        cmd.CommandTimeout = 180
        grd.DataCommand = cmd

        Session("rptcmd_clearingaccounttransactions") = cmd
        ...
        grd.Fields.Add(New QueryGrid.GridField("Amount", QueryGrid.eFieldType.Currency, Nothing, "Amount", SqlDbType.Money, True, "tblRegister.Amount"))
    ...
    Private Function GetCriteria() As String
        ...
        If Not String.IsNullOrEmpty(txtAmount1.Text) Then
            Where = AddCriteria(Where, "-tblRegister.Amount >= " & txtAmount1.Text)
        End If

        If Not String.IsNullOrEmpty(txtAmount2.Text) Then
            Where = AddCriteria(Where, "-tblRegister.Amount <= " & txtAmount2.Text)
        End If
...
#End Region
    ...
    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        AddControl(pnlBody, c, "Research-Queries-Financial-Accounting-General Clearing Account Transfer")
    End Sub
End Class