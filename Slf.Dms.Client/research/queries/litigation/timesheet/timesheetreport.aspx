<%@ Page Language="VB" MasterPageFile="~/research/research.master" AutoEventWireup="false"
    CodeFile="timesheetreport.aspx.vb" Inherits="research_reports_matters_timesheet_timesheetreport"
    Title="DMP - Time Expense Entry Report" %>
...
function AddHandler(eventSource, eventName, handlerName, eventParent)
{
    ...
    else
    {
        ...
        <body scroll="yes" onload="SetKeyPress();">
                                ...
                                <tr>
                                    <td>
                                        <table style="width: 100%; font-family: tahoma; font-size: 11;" cellpadding="0" border="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblCompany" runat="server"><b>Company</b></asp:Label><br />
                                                    <br />
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label1" runat="server"><b>Attorney</b></asp:Label><br />
                                                    <br />
                                                    <asp:DropDownList ID="ddlAttorney" AccessKey="2" runat="server" Style="font-family: tahoma;
                                                        font-size: 11px; width: 100%;" />
                                                </td>
                                            </tr>
                                        </table>
                                                    ...
                                                    <table style="height: 25; background-image: url(<%= ResolveUrl("~/images/grid_top_back.bmp") %>);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td nowrap="true" style="width: 10;">
                                                                <a id="A3" runat="server" href="javascript:window.print();">
                                                                    <img id="Img4" runat="server" src="~/images/16x16_print.png" border="0" align="absmiddle" /></a>
                                                            </td>
                                                            <td nowrap="true" style="width: 10;">
                                                                &nbsp;
                                                            </td>
                                ...
                                <tr>
                                    <td valign="top" style="width: 100%; height: 100%; border-left: solid 1px rgb(172,168,153);">
                                        <div>
                                            ...
                                            <table style="background-color: #f3f3f3; font-family: tahoma; font-size: 11px; width: 100%;
                                                table-layout: fixed" cellpadding="0" cellspacing="0" border="0">
                                                <tr valign="top">
                                                    <td valign="top" colspan="3">
                                                        <div class="grid" style="overflow-y: hidden; overflow-x: auto; width: 100%; height: 400px">
                                                            <asp:Panel runat="server" ID="pnlNoTasks" Visible="false" Style="text-align: center;
                                                                font-style: italic; padding: 10 5 5 5;">
                                                                Selected criteria has no expense entries</asp:Panel>
                                                            <asp:GridView ID="gvResults" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                                                AllowSorting="True" CssClass="datatable" CellPadding="0" BorderWidth="0px" PageSize="20"
                                                                GridLines="None">
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField DataField="CompanyName" HeaderText="Company&nbsp;Name" SortExpression="CompanyName">
                                                                     ...
                                                                     <asp:BoundField DataField="Attorney" HeaderText="Attorney" SortExpression="Attorney">
                                                                        <ItemStyle Font-Names="tahoma" Wrap="false" />
                                                                        <HeaderStyle Font-Bold="false" HorizontalAlign="Left" />
                                                                    </asp:BoundField>
                                                                    ...
                                                                    <asp:BoundField DataField="TimeExpenseDatetime" SortExpression="TimeExpenseDatetime" HeaderText="Expense&nbsp;Date" DataFormatString="{0:dd MMM, yyyy}">
                                                                        <ItemStyle Font-Names="tahoma" Wrap="false" />
                                                                        <HeaderStyle Font-Bold="false" HorizontalAlign="Left" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="TimeExpenseDescription" HeaderText="Description" SortExpression="TimeExpenseDescription">
                                                                        <ItemStyle Font-Names="tahoma" Wrap="false" />
                                                                        <HeaderStyle Font-Bold="false" HorizontalAlign="Left" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="BillableTime" SortExpression="BillableTime" HeaderText="Billable&nbsp;Time">
                                                                        <ItemStyle Font-Names="tahoma" Wrap="false" HorizontalAlign="Right" />
                                                                        <HeaderStyle Font-Bold="false" HorizontalAlign="Left" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="BillRate" SortExpression="BillRate" HeaderText="Bill&nbsp;Rate">
                                                                        <ItemStyle Font-Names="tahoma" Wrap="false" HorizontalAlign="Right" />
                                                                        <HeaderStyle Font-Bold="false" HorizontalAlign="Left" />
                                                                    </asp:BoundField>
                                                                    <asp:BoundField DataField="SubTotal" SortExpression="SubTotal" HeaderText="Sub&nbsp;Total">
                                                                        <ItemStyle Font-Names="tahoma" Wrap="false" HorizontalAlign="Right" />
                                                                        <HeaderStyle Font-Bold="false" HorizontalAlign="Left" />
                                                                    </asp:BoundField>
                                                                </Columns>
