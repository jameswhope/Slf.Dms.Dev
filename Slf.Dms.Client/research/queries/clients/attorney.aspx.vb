...
Partial Class research_queries_clients_attorney
...
#Region "Event"
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not qs Is Nothing Then
            'load attorney stuff
            Dim AttorneyIdString As String = DataHelper.FieldLookup("tblAttorney", "AttorneyId", "UserId=" & DataHelper.Nz_int(Page.User.Identity.Name))
            If Not String.IsNullOrEmpty(AttorneyIdString) Then

                AttorneyId = Integer.Parse(AttorneyIdString)
...
#Region "Util"
    ...
    Public Overrides Sub AddPermissionControls(ByVal c As System.Collections.Generic.Dictionary(Of String, System.Web.UI.Control))
        ...
        AddControl(pnlBody, c, "Research-Queries-Clients-Attorney")
...
#Region "Query"
    ...
    Private Sub Requery(ByVal Reset As Boolean)
        ...
        Dim cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_AttorneyGetClientInfo")
        AddStdParams(cmd)
        cmd.CommandTimeout = 180
        grd.DataCommand = cmd

        Session("rptcmd_query_clients_attorney") = cmd
