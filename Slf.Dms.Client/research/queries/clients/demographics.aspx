<%@ Page Language="VB" MasterPageFile="~/research/research.master" AutoEventWireup="false" CodeFile="demographics.aspx.vb" Inherits="research_queries_clients_demographics" title="DMP - Service Fees" %>
        ...
        <td valign="top" id="tdFilter" runat="server">
            <div style="padding:15 15 15 15;overflow:auto;height:100%;width:175;">
                <table style="font-family:tahoma;font-size:11px;width:100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <asp:RadioButtonList CssClass="entry" cellpadding="0" cellspacing="0" runat="server" id="optStateChoice">
                                <asp:ListItem value="0" text="Exclude states"/>
                                <asp:ListItem value="1" text="Include states" selected="true"/>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asi:SmartCriteriaSelector TableStyle="width:100%;" SelectedStyle="font-family:tahoma;font-size:11px;width:100%;" selectorstyle="font-family:tahoma;font-size:11px;width:100%;" runat="server" id="csStateID" SelectedRows="3"></asi:SmartCriteriaSelector >
                        </td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                     <tr>
                        <td>
                            <asp:RadioButtonList CssClass="entry" cellpadding="0" cellspacing="0" runat="server" id="optLanguageChoice">
                                <asp:ListItem value="0" text="Exclude languages"/>
                                <asp:ListItem value="1" text="Include languages" selected="true"/>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asi:SmartCriteriaSelector TableStyle="width:100%;" SelectedStyle="font-family:tahoma;font-size:11px;width:100%;" selectorstyle="font-family:tahoma;font-size:11px;width:100%;" runat="server" id="csLanguageID" SelectedRows="3"></asi:SmartCriteriaSelector>
                        </td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td style="padding-bottom:10;"><b>Settlement Attorney</b></td>
                    </tr>
                    <tr>
                        <td nowrap="true">
                            <asp:DropDownList ID="ddlCompany" runat="server" CssClass="entry">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td style="padding-bottom:10;"><b>Gender</b></td>
                    </tr>
                    <tr>
                        <td nowrap="true">
                            <asp:CheckBox style="font-size: 11px; font-family: Tahoma" selected="true" Text="Male" id="chkMale" runat="server" />
                            <asp:CheckBox style="font-size: 11px; font-family: Tahoma" selected="true" Text="Female" id="chkFemale" runat="server"/>
                        </td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                        <td style="padding-bottom:10;"><b>Created</b></td>
                    </tr>
                    <tr>
                        <td>
