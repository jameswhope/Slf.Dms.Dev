            ...
            <tr>
                ...
                <td nowrap="true">
                    <a class="menuButton" href="javascript:Record_Save();">
                        <img runat="server" align="absmiddle" border="0" class="menuButtonImage" src="~/images/16x16_save.png" />Resolve Task</a></td>
...
<body>
    ...
    function OpenNotes()
    {
        showModalDialog("<%= ResolveUrl("~/tasks/task/notesholder.aspx") %>", window, "status:off;help:off;dialogWidth:500px;dialogHeight:350px");
    }
    ...
    {
        showModalDialog("<%= ResolveUrl("~/util/pop/holder.aspx") %>?t=Task Propagation&p=<%= ResolveUrl("~/tasks/task/propagations.aspx") %>", window, "status:off;help:off;dialogWidth:600px;dialogHeight:450px");
    }
                                                ...
                                                <tr runat="server" id="trResolutionBody">
                                                    <td style="padding:5 10 20 10;">
                                                        <table style="width: 100%; font-family: tahoma; font-size: 11px;" cellpadding="0" cellspacing="3" border="0">
                                                            <tr>
                                                                <td>Resolved:</td>
                                                                <td><cc1:InputMask Mask="nn/nn/nnnn nn:nn aa" CssClass="entry" runat="server" ID="txtResolved"></cc1:InputMask><asp:Label runat="server" id="Label1"></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Task Is:</td>
                                        ...
                                        <td>
                                            <table style="width:100%;font-family:tahoma;font-size:11px;" cellpadding="0" cellspacing="0" border="0">
                                                <tr style="background-color:#f1f1f1;">
                                                    ...
                                                    <td style="padding-right:10;" align="right"><a style="color:black;" class="lnk" href="javascript:OpenNotes();"><img border="0" align="absmiddle" src="~/images/16x16_note.png" runat="server" style="margin-right:5;"/>Notes</a><asp:Label runat="server" ForeColor="blue" ID="lblNotes"></asp:Label>&nbsp;&nbsp;&nbsp;<a style="color:black;" href="javascript:OpenPropagations();" class="lnk"><img border="0" align="absmiddle" src="~/images/16x16_calendar_add.png" runat="server" style="margin-right:5;"/>Propagations</a><asp:Label ForeColor="blue" runat="server" ID="lblPropagations"></asp:Label></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
