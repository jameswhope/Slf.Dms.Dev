    ...
    <asp:Panel runat="server" ID="pnlBody">
        <table style="width: 100%;" cellpadding="0" cellspacing="15" border="0">
            <tr>
                ...
                <td align="right">    <asp:CheckBox AutoPostBack="true" runat="server" CssClass="entry2"   ID="chkDueOnly" Text="Due Today"
                         />&nbsp;
                    <asp:CheckBox AutoPostBack="true" runat="server" CssClass="entry2"   ID="chkTeamOpenOnly" Text=" Open Only"
                         /><asp:PlaceHolder ID="pnlSearchTeamTasks" runat="server">&nbsp;&nbsp;
                    ...
                    <div id="dvTeamTasks" runat="server">
                        <table onselectstart="return false;" style="table-layout: fixed; font-size: 11px;
                            ...
                            <tr>
                                ...
                                <td class="headItem" style="width: 80;" id="tdAssignHeader"  onclick="Sort(this)" runat="server">
                                    Assigned To
                                </td>
                                <td class="headItem" style="width: 120;" id="tdReAssign"  runat="server" >
                                    ReAssign To
                                </td>
