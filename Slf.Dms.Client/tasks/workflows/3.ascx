<%@ Control Language="VB" AutoEventWireup="false" CodeFile="3.ascx.vb" Inherits="tasks_workflows_3" %>
...
function LoadControls()
{
    if (txtResolved == null)
    {
        ...
        cboTrustID = document.getElementById("<%= cboTrustID.ClientID %>");
...
<br />1. Verify this client's fee structure:<br /><br />
