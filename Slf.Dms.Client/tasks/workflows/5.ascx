<%@ Control Language="VB" AutoEventWireup="false" CodeFile="5.ascx.vb" Inherits="tasks_workflows_5" %>
...
Print the following documents and send to creditor.
<ul>
    <li>Notification Letter</li>
    <li>Copy of POA</li>
</ul>
<br />
Print the following documents and send to client.
<ul>
    <li>Welcome Letter</li>
    <li>Cover Letter</li>
    <li>Verification Sheet</li>
    <li>Copies of Notification Letter</li>
</ul>
Eventually, this workflow will allow you to print automated reports for each of these items.  This
