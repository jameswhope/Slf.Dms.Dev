   ...
   function LoadControls() {
        if (ddlLDocument == null) {
           ...
           chkr4=document.getElementById("<%= chkr4.ClientID %>");
            cmbClients=document.getElementById("<%= cmbClients.ClientID %>");
              txtplantiff=document.getElementById("<%= txtplantiff.ClientID %>");
        }
    }
    ...
    function RequiredExist() {
        ...
        if (cmbRecType.value == "") {
          ...
          if (txtplantiff.value == null || txtplantiff.value.length == 0) {
            ShowMessage("Who is the plantiff is a required field");
            AddBorder(txtplantiff);
            return false;
        }
       ...
       if ((cmbAid.value =="Yes") && (chkr1.checked == false) && (chkr2.checked == false) && (chkr3.checked == false) && (chkr3.checked == false)) {
                                ...
                                <td>
                                    <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="1"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             <asp:DropDownList ID="cmbClients" runat="server"  CssClass="entry"  ></asp:DropDownList>
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtplantiff" runat="server" Width="150px" CssClass="entry"></asp:TextBox>
                                                </td>
                                                <td colspan="4">
                                                    &nbsp;
                                                </td>
