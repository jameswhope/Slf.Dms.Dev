<%@ Control Language="VB" AutoEventWireup="false" CodeFile="2.ascx.vb" Inherits="tasks_workflows_2" %>
...
<ul>
    <li>
        Review this client's account to see if they have sent in the LSA and deposit.
    <li>
        If either the LSA or deposit have not come in, call this client on the telephone.
    <li>
        Fill out thorough notes of the conversation on the right.
    <li>
        Make sure the Task Resolution fields above are filled properly, then click the Resolve Task
        button on the menu bar.
    </li>
</ul>
Eventually, this workflow will provide you links to directly call this client's primary
phone number. This portion is under development.
