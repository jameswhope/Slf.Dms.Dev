        ...
        */
        function AttachDocument()
        {
            ...
            var t = (screen.height - h) / 2;
             ...
             var url = '<%= ResolveUrl("~/util/pop/attachmatterdocument.aspx") %>?a=m&id=<%= ClientID %>&ciid=<%=CreditorInstanceId %>&type=matter&rel='+relID;
        ...
        {
            var url = '<%= ResolveUrl("~/clients/client/creditors/matters/Intake.aspx") %>?a=m&id=<%=ClientID %>&mid=<%=MatterId%>&aid=<%=AccountId%>';
             window.dialogArguments = window;
             currentModalDialog = $('<div/>').appendTo("body").modaldialog({url: url,
        ...
        function UploadDocument()
        {
            ...
            var url = '<%= ResolveUrl("~/util/pop/Uploadmatterdocument.aspx") %>?a=m&type=matter&temp=1&id=<%=ClientID %>&rel=<%=hdnTempMatterID.value %>&ciid=<%=CreditorInstanceId %>';
             window.dialogArguments = window;
             currentModalDialog = $('<div/>').appendTo("body").modaldialog({url: url,
