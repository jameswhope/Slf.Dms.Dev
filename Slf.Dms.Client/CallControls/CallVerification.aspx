<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CallVerification.aspx.vb" Inherits="CallControls_CallVerification" %>
...
<head runat="server">
    ...
    <script type="text/javascript" >
        function CloseDialog(finished) {
            ...
            {
            case '1':
                var hdnVerifId = document.getElementById('<%=hdnVerificationCallId.ClientID %>');
                window.dialogArguments.parent.CompleteUWVerificationCall(hdnVerifId.value);
                break;
            case '2':
                window.dialogArguments.parent.stopRecording();
                var hdnRep = document.getElementById('<%=hdnRepExt.ClientID %>');
                if (hdnRep != '') {
                    window.dialogArguments.parent.transfer_call(hdnRep.value);
                }
                break;  
            default: 
                window.dialogArguments.parent.stopRecording();
                            ...
                            <table class="formTable">
                                ...
                                <tr>
                                    <td class="footer">
                                        ...
                                        <asp:Button CssClass="btnNoRed" ID="Button22" runat="server" Text="No" CommandName='<%#iif(Container.DataItem("FailWhenNo"),"AnsweredNo","ContinueWithNo") %>' CommandArgument='<%#Container.DataItem("QuestionNo")%>' OnClientClick="return ConfirmAnswerNo();" />
                                    </td>
                                 </tr>
                            </table>
                         </ItemTemplate> 
