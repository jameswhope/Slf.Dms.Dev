<%@ Page Title="" Language="VB" MasterPageFile="~/portals/affiliate/affiliate.master" AutoEventWireup="false"
    CodeFile="reports.aspx.vb" Inherits="portals_affiliate_reports" %>
    ...
    <asp:UpdatePanel ID="upReports" runat="server">
        <ContentTemplate>
            <div class="portlet">
                ...
                <div id="report-tabs">
                    <ul>
                        <li><a href="#tabs-daily">Daily Summary<asp:Label ID="lblViewDaily" runat="server"
                            Text="" />
                        </a></li>
                        <li><a href="#tabs-sub">SubAffiliate Summary<asp:Label ID="lblViewSub" runat="server"
                            Text="" /></a></li>
                        <li><a href="#tabs-conv">Conversion Report<asp:Label ID="lblViewConv" runat="server"
                            Text="" /></a></li>
                        <li><a href="#tabs-click">Click Report<asp:Label ID="lblViewClick" runat="server"
                            Text="" /></a></li>
                    </ul>
                    <div id="tabs-daily">
                        <asp:GridView ID="gvDailySummary" runat="server" OnRowCreated="gv_RowCreated" Width="100%"
                            AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="dsDailySummary" OnPreRender="gv_PreRender"
                            ShowFooter="True">
                    ...
                    <div id="tabs-sub">
                        <asp:GridView ID="gvSubAffiliate" runat="server" OnRowCreated="gv_RowCreated" Width="100%"
                            AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="dsSubAffiliate" OnPreRender="gv_PreRender"
                            PageSize="20">
                            <HeaderStyle CssClass="ui-widget-header" Height="30" />
                            <RowStyle CssClass="ui-widget-content" />
                            <FooterStyle CssClass="footerRow" />
                                    ...
                                    <small>
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton CssClass="jqButton" ID="lnkExport" runat="server" Text="Export" Style="float: right!important"
                                                        OnClientClick="return CreateCSV(1);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </small>
                        ...
                        <asp:SqlDataSource ID="dsSubAffiliate" runat="server" ConnectionString="<%$ ConnectionStrings:IDENTIFYLEDB %>"
                            SelectCommand="stp_affiliate_getSubAffiliateSummaryReport" SelectCommandType="StoredProcedure"
                    ...
                    <div id="tabs-conv">
                        <asp:GridView ID="gvConversions" runat="server" OnRowCreated="gv_RowCreated" Width="100%"
                            AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="dsConversions" OnPreRender="gv_PreRender"
                            PageSize="20">
                            <HeaderStyle CssClass="ui-widget-header" Height="30" />
                            <RowStyle CssClass="ui-widget-content" />
                            <Columns>
                                <asp:BoundField DataField="ConversionID" HeaderText="Conversion ID" SortExpression="ConversionID">
                                ...
                                <asp:BoundField DataField="SubID1" HeaderText="SubID1" SortExpression="SubID1">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SubID2" HeaderText="SubID2" SortExpression="SubID2">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SubID3" HeaderText="SubID3" SortExpression="SubID3">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SubID4" HeaderText="SubID4" SortExpression="SubID4">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="SubID5" HeaderText="SubID5" SortExpression="SubID5">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                    ...
                                    <small>
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton CssClass="jqButton" ID="lnkExport" runat="server" Text="Export" Style="float: right!important"
                                                        OnClientClick="return CreateCSV(2);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </small>
                        ...
                        <asp:SqlDataSource ID="dsConversions" runat="server" ConnectionString="<%$ ConnectionStrings:IDENTIFYLEDB %>"
                            CancelSelectOnNullParameter="False" SelectCommand="stp_affiliate_getConversionReport"
                            SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:Parameter Name="UserID" Type="Int32" />
                                <asp:Parameter Name="Offer" Type="String" ConvertEmptyStringToNull="true" />
                                <asp:Parameter Name="Campaign" Type="String" ConvertEmptyStringToNull="true" />
                                <asp:Parameter Name="from" Type="DateTime" />
                                <asp:Parameter Name="to" Type="DateTime" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    ...
                    <div id="tabs-click">
                        <asp:GridView ID="gvClick" runat="server" OnRowCreated="gv_RowCreated" Width="100%"
                            AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="dsClick" OnPreRender="gv_PreRender"
                            PageSize="20">
                            <HeaderStyle CssClass="ui-widget-header" Height="30" />
                            <RowStyle CssClass="ui-widget-content" />
                            <Columns>
                                ...
                                <asp:BoundField DataField="conv_date" HeaderText="Conversion Date" SortExpression="conv_date">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Campaign" HeaderText="Campaign" SortExpression="Campaign">
                                ...
                                <asp:BoundField DataField="TotalClicks" HeaderText="Total Clicks" SortExpression="TotalClicks">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                            </Columns>
                                    ...
                                    <small>
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton CssClass="jqButton" ID="lnkExport" runat="server" Text="Export" Style="float: right!important"
                                                        OnClientClick="return CreateCSV(3);" />
                                                </td>
                                            </tr>
                                        </table>
                                    </small>
                        ...
                        <asp:SqlDataSource ID="dsClick" runat="server" ConnectionString="<%$ ConnectionStrings:IDENTIFYLEDB %>"
                            CancelSelectOnNullParameter="False" SelectCommand="stp_affiliate_getClickReport"
                            SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:Parameter Name="UserID" Type="Int32" />
                                <asp:Parameter Name="Offer" Type="String" ConvertEmptyStringToNull="true" />
