<%@ Page Title="" Language="VB" MasterPageFile="~/portals/affiliate/affiliate.master" AutoEventWireup="false"
    CodeFile="SubAffiliateSummary.aspx.vb" Inherits="portals_affiliate_reports_SubAffiliateSummary" %>
        ...
        <ContentTemplate>
            <div class="portlet">
                <div class="portlet-header">
                    ::: SubAffiliate Summary<asp:Label ID="lblViewSub" runat="server"
                            Text="" /></div>
