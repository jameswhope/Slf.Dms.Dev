<%@ Page Title="" Language="VB" MasterPageFile="~/portals/affiliate/affiliate.master" AutoEventWireup="false"
    CodeFile="ConversionReport.aspx.vb" Inherits="portals_affiliate_reports_ConversionReport" %>
        ...
        <ContentTemplate>
            <div class="portlet">
                ...
                <div class="portlet-content">
                    <div class="portlet">
                        <div class="portlet-header filter">
                            ::: Conversion Report<asp:Label ID="lblViewConv" runat="server" Text="" /></div>
                        <div class="portlet-content">
                ...
                <asp:GridView ID="gvConversions" runat="server" OnRowCreated="gv_RowCreated" Width="100%"
                    AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="dsConversions"
                    OnPreRender="gv_PreRender" PageSize="20">
