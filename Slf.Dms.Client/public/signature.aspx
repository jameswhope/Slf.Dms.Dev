<%@ Page Language="VB" AutoEventWireup="false" CodeFile="signature.aspx.vb" Inherits="public_signature" %>
                            ...
                            <tr valign="bottom">
                                <td>
                                    <ol>
                                        ...
                                        <li>Click <a id="hpMobile" runat="server">here</a> to use the mobile version.</li>
                                    </ol>
                                </td>
                                <td>
                                    <table style="width: 100%;">
