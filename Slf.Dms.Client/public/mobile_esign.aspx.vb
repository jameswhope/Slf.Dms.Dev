...
Partial Class public_mobile_esign
...
#Region "Methods"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Added ccastelo 12/12/12 9:12am
        hpStandard.HRef = String.Format("esign.aspx?sbId={0}&hyp=1", _SigningBatchID)
        'end
    ...
    Protected Sub lnkSign_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkSign.Click
        ...
        Else
            ClientScript.RegisterStartupScript(Me.GetType, "NoSig", "alert('Please type in your signature and apply your signatures before signing!');", True)
            'LoadPage(CurrentDoc, CurrentPage)
        End If
    End Sub
            ...
            If tblDoc.Rows(0)("completed") Is DBNull.Value Then
                ...
                For Each d As DataRow In tblDoc.Rows
                    ...
                    If bFirstRun Then
                        ...
                        If Screen.PrimaryScreen.Bounds.Width > 360 Then
                            sigFrameType = "mySignatureTyped"
                        Else
