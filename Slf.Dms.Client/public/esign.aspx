<%@ Page Language="VB" AutoEventWireup="false" CodeFile="esign.aspx.vb" Inherits="public_esign" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var x = document.getElementById("phContent");
        x.style.width = w;
    </script>
...
<body>
    ...
    <asp:ScriptManager ID="smEsign" runat="server" EnablePageMethods="true" />
                        ...
                        <table style="width: 100%">
                            <tr valign="bottom">
                                <td>
									...
									<li>Click <a id="hpMobile" runat="server">here</a> to use the type version.</li>
                                    </ol>
                                </td>
                                <td>
                                    <table style="width: 100%;">
                ...
                <td id="tdDocuments" runat="server" rowspan="2" align="center" style="background-color: Gray;
                    ...
                    <div id="pdfWrapper">
                            ...
                            <tr valign="top">
                                <td align="left" valign="top">
                                    <asp:UpdatePanel ID="upDocument" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                        <ContentTemplate>
                                            <div id="phContent" runat="server" style="padding: 3px; height: 100%;" />
                                            <div id="confirmBox">
                        ...
                        <iframe id="iPDF" runat="server" marginheight="0" marginwidth="0" src="" scrolling="no"
                            frameborder="0" style="height: 1000px; display: none;" />
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <div class="signatures">
                        <div class="signature">
                            ...
                            <iframe id="iSignature" runat="server" marginheight="0" marginwidth="0" src="" scrolling="no"
                                frameborder="0" width="275px" height="100px"></iframe>
                        </div>
                        <div class="initial">
                            <div>
                                Initials:</div>
                    ...
                    <div id="divCoApp" runat="server" class="signatures">
                        <div class="signature">
                            ...
                            <iframe id="iCoSignature" runat="server" marginheight="0" marginwidth="0" src=""
                                scrolling="no" frameborder="0" width="275px" height="100px"></iframe>
                        </div>
                        <div class="initial">
                            <div>
                                Initials:</div>
