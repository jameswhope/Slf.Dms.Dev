<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LexxSign.aspx.vb" Inherits="LexxSign" %>
    ...
    <script type="text/javascript">
        ...
        function saveNoSign() {
            ...
            if (iSig.contentWindow.hasSignature()) {
                ...
                iSig.contentWindow.save();
                if('<%=bHideInits %>' != 'True'){
                    if(iIni.contentWindow.hasSignature()){
                        iIni.contentWindow.save();
                    }
                }
                if (iCoSig) {
                ...
                <td id="tdDocuments" runat="server" rowspan="2" align="center" style="background-color: Gray;
                    ...
                    <div id="pdfWrapper">
                        ...
                        <iframe id="iPDF" runat="server" marginheight="0" marginwidth="0" src="" scrolling="no"
                            frameborder="0" style="width: 850px; height: 400px; display: none;" />
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div id="clickWrapper" runat="server">
                        ...
                        <div style="padding: 5px;" class="entry2">
                            <asp:LinkButton  ID="lnkRejectSign" runat="server" Text="Click to Reject"  ForeColor="Red"
                                CssClass="lnk" />
                        </div>
                    </div>
                </td>
                ...
                <div id="dvReport" runat="server" style="z-index: 51; visibility: visible; background-color: Transparent;">
                    <div id="sigWrapper" runat="server">
                        <div class="signatures">
                            ...
                            <div class="initial" id="divInitials" runat="server">
                                <div>
                                    Initials:</div>
