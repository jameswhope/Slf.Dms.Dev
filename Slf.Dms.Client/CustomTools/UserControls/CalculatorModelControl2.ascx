<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CalculatorModelControl2.ascx.vb" Inherits="CalculatorModelControl2" %>
<style type="text/css">
    .InfoMsg
    {
        ...
        <td>
            <table class="entry" border="0" style=" border-collapse:collapse;" cellpadding="0" cellspacing="0" >
                ...
                <tr class="entry2">
                    ...
                    <td>
                        <asp:TextBox ID="txtSettlementFeePct" CssClass="entry" runat="server" Style="text-align: right;" Text="33"
...
-                    <td>
                ...
                <tr class="entry2" id="trProperties">
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TextBox1" CssClass="entry" runat="server" Style="text-align: right; display:none;"
                            Width="75px" Enabled="false"></asp:TextBox>
                    </td>
