...
Partial Class CalculatorModelControl2
...
#Region "Methods"
    ...
    Private Function CalcNewModel(ByVal DepositCommittmentAmt As Double) As DataTable
        ...
        Dim rowSett, rowFees, rowServ, rowCost, rowFee2Cost, rowTerm, rowTermYears As Data.DataRow
        ...
        rowFees("col1") = "Fixed Legal Fees<sup>(11)</sup>"
        rowServ("col1") = "Total Congingency Fees<sup>(12)</sup>"
        rowCost("col1") = "Total Resolution Cost<sup>(13)</sup>"
        rowFee2Cost("col1") = "% Fees to Total Cost<sup>(14)</sup>"
        rowTerm("col1") = "Number of Months<sup>(15)</sup>"
        rowTermYears("col1") = "Number of Years<sup>(16)</sup>"
        ...
        For Each pct As String In lstPct
            ...
            For Each record As Results In _Results
                If record.PercentageOfSettlement = pct AndAlso record.MonthlyDeposit = DepositCommittmentAmt AndAlso DepositCommittment <> 0 Then
                    ...
                    rowServ(colName) = FormatCurrency(record.ContingencyFees)
    ...
    Private Function GetFixedFeeListPct() As String()
        Dim lst As New List(Of String)
        Dim lstVals As String = SqlHelper.ExecuteScalar("select Value from tblProperty where Name = 'FitzEnrollmentFixedFeePercentages'", CommandType.Text)
        lst.AddRange(lstVals.Split(New Char() {"|"}, StringSplitOptions.RemoveEmptyEntries))
        Return lst.ToArray
    End Function

    Public Sub LoadClientData(ApplicantID As Integer)
        ...
        txtSettlementFeePct.Text = 33.0 'CDbl(_Results(0).SettlementFeePercentage) * 100
        'End If
