<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CalculatorModelControl3.ascx.vb" Inherits="CalculatorModelControl3" %>
<style type="text/css">
    .InfoMsg
    {
...
<script>
    function pageLoad() {
        ...
        $(document).ready(function () {
            if $('#<%=txtTotalDebt.ClientID %>').val() > 10000
            {
                if ($('#<%=txtTotalDebt.ClientID %>').val() * .035) > $('#<%=txtInitialDeposit.ClientID %>').val()
                {
                    var inputInit = document.getElementById('<%=txtInitialDeposit.ClientID%>');    
                    inputInit.style.backgroundColor = "#FF0000";
                }
            }
        }
    }
...
-                    <td>
                ...
                <tr class="entry2" id="trProperties">
                    ...
                    <td>
                        <asp:Label ID="lblFixedFee" runat="server" Text="Fixed Fee" style="text-align: left;" Visible="true"></asp:Label>
                    </td>
                    <td>&nbsp;
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlFixedFee" runat="server" AutoPostBack="true" style="text-align: right;" Visible="true"  Width="75px">
                        </asp:DropDownList>%
                        <asp:TextBox ID="txtSettlementFeePct" CssClass="entry" runat="server" Style="text-align: right; display:none;"
...
<div id="tblBody" runat="server">
    ...
    <br />
    <asp:GridView ID="gvExample" runat="server" CssClass="entry" Caption="<div style='text-align:left;background-color:#F0E68C;'><b>Referred Debt Example<sup>(7)(8)</sup></b></div>"
        AutoGenerateColumns="false" HeaderStyle-VerticalAlign="Bottom">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Number Of Accounts">
                <ItemTemplate>
                    <div>
