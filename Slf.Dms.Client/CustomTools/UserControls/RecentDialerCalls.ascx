<%@ Control Language="VB" AutoEventWireup="false" CodeFile="RecentDialerCalls.ascx.vb" Inherits="CustomTools_UserControls_RecentDialerCalls" %>
            ...
            <ItemTemplate>
                <tr>
                    <td nowrap="nowrap" style="padding: 0px 5px 5px 20px;">
                        <a class="lnk" href="#" onclick="javascript:RecentCall('<%#DataBinder.Eval(Container.DataItem, "CallMadeId")%>', '<%#DataBinder.Eval(Container.DataItem, "ClientId")%>');" title="<%#DataBinder.Eval(Container.DataItem, "FullName")%>&nbsp;<%# DataBinder.Eval(Container.DataItem, "EventDate")%>" >
