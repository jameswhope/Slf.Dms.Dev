...
customController.includeJS('MapDAD/GroupLegend');
customController.includeJS('MapDAD/MapCanvas');
customController.includeJS('MapDAD/MapCanvasScrollbar');
...
customController.includeJS('MapDAD/ToolboxCursor');
customController.includeJS('MapDAD/ToolboxItem');

customController.includeCSS('MapDAD/css/MapDAD');
...
function RemoveChild(parent, child)
{
    ...
    if ((parent.get_element().id != child.get_element().id) && siblings)
    {
        ...
        document.body.removeChild(document.getElementById(child.get_element().id + 'VLineP'));
        document.body.removeChild(document.getElementById(child.get_element().id + 'HLineC'));
        document.body.removeChild(document.getElementById(child.get_element().id + 'VLineC'));
