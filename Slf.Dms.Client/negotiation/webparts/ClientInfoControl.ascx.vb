                ...
                If Not rowView("CurrentCreditorName").ToString = "" Then
                    ...
                    Select Case rowView("AccountStatusID").ToString
                        Case "54"
                            ...
                            If PaymentScheduleHelper.IsAccountSettledWithActivePA(rowView("accountid"), settid) AndAlso settid.HasValue AndAlso settid.Value > 0 Then
                                e.Row.Style("background-color") = "#CEECF5"
                            Else
