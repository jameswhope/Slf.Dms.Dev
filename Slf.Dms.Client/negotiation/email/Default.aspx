<%@ Page Language="VB" MasterPageFile="~/negotiation/Negotiation.master" AutoEventWireup="false" EnableEventValidation="false" CodeFile="Default.aspx.vb" Inherits="negotiation_email_Default" title="Untitled Page" %>

<%@ Register Src="~/negotiation/webparts/Email.ascx" TagName="Email" TagPrefix="em" %>
            ...
            <tr>
                <td style="text-align:center;vertical-align:top;">
                    <asp:WebPartZone ID="NavBarZone" HeaderText="NavBar" BorderWidth="0px" Padding="3" WebPartVerbRenderMode="TitleBar" runat="server">
                        <ZoneTemplate>
                            <em:Email ID="emEmail" title="My Email" runat="server" />
                        </ZoneTemplate>
