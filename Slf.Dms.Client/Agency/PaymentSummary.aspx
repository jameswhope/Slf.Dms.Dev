<%@ Page Title="Payment Summary" Language="VB" MasterPageFile="~/Agency/agency.master" AutoEventWireup="false" CodeFile="PaymentSummary.aspx.vb" Inherits="Agency_PaymentSummary" EnableEventValidation="false" %>
                                ...
                                <table id="Table2" runat="server" class="sideRollupCellBodyTable" cellpadding="0" cellspacing="7" border="0">
                                    <tr>
                                        <td>
                                            ...
                                            <asp:SqlDataSource ID="ds_InitialDrafts" runat="server" ConnectionString="<%$ ConnectionStrings:DMS_RESTOREDConnectionString %>" SelectCommand="stp_AgencyInitialDraftsCommission" SelectCommandType="StoredProcedure" EnableCaching="false" ProviderName="<%$ ConnectionStrings:DMS_RESTOREDConnectionString.ProviderName %>">
                                                <SelectParameters>
                                ...
                                <table id="Table1" runat="server" class="sideRollupCellBodyTable" cellpadding="0" cellspacing="7" border="0">
                                    <tr>
                                        <td>
                                            ...
                                            <asp:SqlDataSource ID="ds_NonInitialDrafts" runat="server" ConnectionString="<%$ ConnectionStrings:DMS_RESTOREDConnectionString %>" EnableCaching="false" SelectCommand="stp_AgencyNonInitialDraftsCommission" SelectCommandType="StoredProcedure" ProviderName="<%$ ConnectionStrings:DMS_RESTOREDConnectionString.ProviderName %>">
                                                <SelectParameters>
                                                    <asp:Parameter Name="startdate" Type="DateTime" />
                                                    <asp:Parameter Name="enddate" Type="DateTime" />
                                                    <asp:Parameter Name="dateperiod" Type="String" />
