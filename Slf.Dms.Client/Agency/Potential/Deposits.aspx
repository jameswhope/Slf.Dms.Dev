<%@ Page Title="Projected Deposits vs. Actual" Language="VB" MasterPageFile="~/Agency/agency.master"
    AutoEventWireup="false" CodeFile="Deposits.aspx.vb" Inherits="Agency_Potential_Deposits" %>
        ...
        <tr>
            <td style="padding: 0 20 20 20">
                <table cellpadding="5" cellspacing="0" border="0" class="entry2">
                    <tr>
                        <td>
                            Projected Deposits vs. Actual | <a href="Payments.aspx">Projected Payments vs. Actual</a>
                            | <a href="Outlook.aspx">Recent & Projected Payments</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
