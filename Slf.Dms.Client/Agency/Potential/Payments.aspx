<%@ Page Title="Projected Payments vs. Actual" Language="VB" MasterPageFile="~/Agency/agency.master"
    AutoEventWireup="false" CodeFile="Payments.aspx.vb" Inherits="Agency_Potential_Payments" %>
        ...
        <tr>
            <td style="padding: 0 20 20 20">
                <table cellpadding="5" cellspacing="0" border="0" class="entry2">
                    <tr>
                        <td>
                            <a href="Deposits.aspx">Projected Deposits vs. Actual</a> | Projected Payments vs.
                            Actual | <a href="Outlook.aspx">Recent & Projected Payments</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
