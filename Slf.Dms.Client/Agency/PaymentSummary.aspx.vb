...
Partial Class Agency_PaymentSummary
    ...
    Private Sub RebindDataSource()
        ...
        ds_InitialDrafts.SelectParameters("UserID").DefaultValue = UserID
        ...
        ds_NonInitialDrafts.SelectParameters("UserID").DefaultValue = UserID
        ...
        ds_Intake.SelectParameters("UserID").DefaultValue = UserID
        ds_Intake.DataBind()
        ...
        For Each col As DataColumn In dw.Table.Columns
            Select Case col.ColumnName.ToLower
                ...
                Case Else
                    ...
                    link.DataNavigateUrlFormatString = "PaymentDetail.aspx?payment=first&type={0}&startdate=" & Me.DateRangeBox.From & "&enddate=" & Me.DateRangeBox.To.AddDays(1) & "&dateperiod=" & Me.DateRangeBox.GroupBy & "&datepartname=" & col.ColumnName & "&id=" & UserID & "&c=" & Request.QueryString("c")
                    ...
                    link2.DataNavigateUrlFormatString = "PaymentDetail.aspx?payment=other&type={0}&startdate=" & Me.DateRangeBox.From & "&enddate=" & Me.DateRangeBox.To.AddDays(1) & "&dateperiod=" & Me.DateRangeBox.GroupBy & "&datepartname=" & col.ColumnName & "&id=" & UserID & "&c=" & Request.QueryString("c")
