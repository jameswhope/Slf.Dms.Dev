...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <ajaxToolkit:ToolkitScriptManager id="smgMain" runat="server" enablepartialrendering="true" />
        ...
        <table style="border:solid 1px black;width:550px;height:94%;text-align:left;vertical-align:middle;margin-top:17px;margin-bottom:10px;">
                ...
                <tr style="height:100%;">
                    <td colspan="9" style="text-align:center;vertical-align:top;width:500px;height:100%;">
                        <asp:UpdatePanel ID="uplBatches" runat="server" enableviewstate="true" rendermode="inline" UpdateMode="Conditional">
                            <ContentTemplate>
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="btnRequery" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                </tr>
        ...
        <asp:UpdateProgress ID="pro" runat="server">
            <ProgressTemplate>
