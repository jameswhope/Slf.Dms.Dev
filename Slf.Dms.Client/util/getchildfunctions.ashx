<%@ WebHandler Language="VB" Class="getchildfunctions" %>
...
Public Class getchildfunctions : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Using cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_Permissions_UserFunctionFunctions_Get")
