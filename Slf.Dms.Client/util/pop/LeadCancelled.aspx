<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LeadCancelled.aspx.vb" Inherits="util_pop_LeadCancelled" Title="Lead cancelled."%>
...
function terminate()
    {   
        ...
        if(vReturnValue != "")
            ...
            {
                alert("You must choose a reason why this applicant is being cancelled.");
            }
    }	
