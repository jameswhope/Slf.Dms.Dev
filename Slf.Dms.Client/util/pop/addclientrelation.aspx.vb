...
Partial Class util_pop_addclientrelation
    ...
    Private Sub Requery()
        ...
        Dim strRowText As String = String.Empty

        If dt.Rows.Count > 0 Then
            For Each r As DataRow In dt.Rows
                strRowText = r(1).ToString() + " " + r(2).ToString() + " " + r(3).ToString()
                sb.Append("<a href=""#"" onclick=""RowClick(this.childNodes(0), " & r(0) & ", '" & strRowText & "');""><tr>")
                For i As Integer = 1 To dt.Columns.Count - 1
                    sb.Append("<td>")
                    Dim o As Object = r(i)
    ...
    Protected Sub lnkAction_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkAction.Click
        ...
        '    End Using
        'End Using
        'Page.ClientScript.RegisterStartupScript(Me.GetType, "exit", "self.top.dialogArguments.location=self.top.dialogArguments.location;window.close();", True)
    End Sub
End Class