<%@ Page Language="VB" AutoEventWireup="true" CodeFile="attachmatterdocument.aspx.vb"
    Inherits="util_pop_attachmatterdocument" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Attach Matter Document</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OnFileClick(i,name)
        {
           
            document.getElementById('<%=hdnDocument.ClientID %>').value = name;
            document.getElementById('<%=hdnType.ClientID %>').value = i;
...
<body style="background-image: url(<%= ResolveUrl("~/images/back.bmp") %>); background-position: left top;
    ...
    <input id="hdnDocument" type="hidden" runat="server" />
     <input id="hdnType" type="hidden" runat="server" />
