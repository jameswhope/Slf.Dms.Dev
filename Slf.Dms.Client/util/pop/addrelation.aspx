<%@ Page ValidateRequest="false" Language="VB" AutoEventWireup="false" CodeFile="addrelation.aspx.vb" Inherits="util_pop_addrelation" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function DoRefresh() {
            self.parent.dialogArguments.location = self.parent.dialogArguments.location; 
            window.close();
        }
        
       function RowClick(tr, Id)
        {
