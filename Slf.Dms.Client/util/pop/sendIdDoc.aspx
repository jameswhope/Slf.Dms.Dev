<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sendIdDoc.aspx.vb" Inherits="util_pop_sendiddoc" %>
...
<body style="background-image: url(<%= ResolveUrl("~/images/back.bmp") %>); background-position: left top;
    ...
    <asp:SqlDataSource ID="ds_DocTypes" runat="server" ConnectionString="<%$ AppSettings:connectionstring %>"
        SelectCommand="select DocumentTypeID, DisplayName from tblDocumentType where DocumentTypeID in (2123, 2124, 2125) order by DisplayName"
