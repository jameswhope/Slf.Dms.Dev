...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            '' 03.18.2010 Commented out Currently not being used
    ...
    Private Function AddNodeForLegacy(ByVal folder As DirectoryInfo, ByVal parentNode As TreeNode, ByVal indent As Integer, ByVal level As Integer) As TreeNode
        ...
        For Each subFile As FileInfo In fileList
            ...
            tempFile = New TreeNode("<table style=""width:100%;border-bottom:solid 1px #d1d1d1;"" onclick=""javascript:OnFileClick(-1,'" + tempName.Replace("\", "\\") + "');""><tr style=""width:100%;font-family:tahoma;font-size:11px;""> <td style=""width:5px;"" align=""right""><input type='checkbox' value='" & tempName.Replace("/", "//") & "$LegacyDocs" & "'  id='chk_file_" & iParentFolder.ToString() & "_" & iFileCount.ToString() & "'/></td> <td style=""width:280px;"" align=""left"">" + DuplicateStr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", indent + 1) + "<img src=""" + ResolveUrl("~/images/16x16_file_new.png") + """ border=""0"" alt="""" />&nbsp;" + subFile.Name + "</td><td style=""width:130px;"" align=""left"">" + "" + "</td><td style=""width:130px;"" align=""left"">" + "" + "</td><td align=""left"">" + "" + "</td></tr></table>")
    ...
    Private Function AddNodeAndDescendents(ByVal folder As DirectoryInfo, ByVal parentNode As TreeNode, ByVal indent As Integer, ByVal level As Integer) As TreeNode
        ...
        '    'tempFile = New TreeNode("<table style=""width:100%;""><tr><td align='right'><input type='checkbox'/></td><td align='left'><table style=""width:100%;border-bottom:solid 1px #d1d1d1;"" onclick=""javascript:OnFileClick('" + tempName.Replace("/", "//") + "');""><tr style=""width:100%;font-family:tahoma;font-size:11px;""> <td style=""width:280px;"" align=""left"">" + DuplicateStr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", indent + 1) + "<img src=""" + ResolveUrl("~/images/16x16_file_new.png") + """ border=""0"" alt="""" />&nbsp;" + tempDoc.DocumentName + "</td><td style=""width:60px;"" align=""left"">" + tempDoc.Received + "</td><td style=""width:60px;"" align=""left"">" + tempDoc.Created + "</td><td align=""left"">" + tempDoc.CreatedBy + "</td></tr></table></td></tr></table> ")
        '    tempFile = New TreeNode("<table style=""width:100%;border-bottom:solid 1px #d1d1d1;"" border='0' ><tr style=""width:100%;font-family:tahoma;font-size:11px;""><td style=""width:5px;"" align=""right""><input type='checkbox' value='" & tempName.Replace("/", "//") & "$" & tempDoc.DocumentName.Replace("'", "\'") & "'  id='chk_file_" & iParentFolder.ToString() & "_" & iFileCount.ToString() & "'/></td><td style=""width:250px;"" align=""left"" onclick=""javascript:OnFileClick('" & tempName.Replace("/", "//") & "','" & tempDoc.DocumentName.Replace("'", "\'") & "');"" >" + DuplicateStr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", indent + 1) + "<img src=""" + ResolveUrl("~/images/16x16_file_new.png") + """ border=""0"" alt="""" />&nbsp;" + tempDoc.DocumentName + "</td><td style=""width:120px;"" align=""left"" onclick=""javascript:OnFileClick('" + tempName.Replace("/", "//") & "','" & tempDoc.DocumentName.Replace("'", "\'") & "');"">" + tempDoc.Received + "</td><td style=""width:120px;"" align=""left"" onclick=""javascript:OnFileClick('" + tempName.Replace("/", "//") & "','" & tempDoc.DocumentName.Replace("'", "\'") & "');"">" + tempDoc.Created + "</td><td align=""left"" onclick=""javascript:OnFileClick('" + tempName.Replace("/", "//") & "','" & tempDoc.DocumentName.Replace("'", "\'") & "');"">" + tempDoc.CreatedBy + "</td></tr></table>")
        ...
        '    iParentFolder = iParentFolder + 1
        '    If level = 2 Then
        '        If subFolder.Name.IndexOf(strCreditorFolder) >= 0 Then
        '            Dim child As TreeNode = AddNodeAndDescendents(subFolder, node, indent + 1, level)
        '            node.ChildNodes.Add(child)
        '        End If
        '    Else
        '        Dim child As TreeNode = AddNodeAndDescendents(subFolder, node, indent + 1, level)
