<%@ Page Language="VB" AutoEventWireup="false" CodeFile="agencypicker.aspx.vb" Inherits="util_pop_agencypicker" %>
        ...
        <tr>
            <td style="padding-top: 15; padding-left: 15; height: 100%;" valign="top">
                <table border="0" cellpadding="0" cellspacing="7" style="font-family: tahoma; font-size: 11px;">
                    <tr>
                        <td>
                            Select agencies to associate with this user account.
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div style="overflow: auto; height: 175px">
                                <asp:CheckBoxList ID="cblAgency" runat="server">
                                </asp:CheckBoxList>
                            </div>
                        </td>
                    </tr>
