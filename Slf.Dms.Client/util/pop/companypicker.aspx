<%@ Page Language="VB" AutoEventWireup="false" CodeFile="companypicker.aspx.vb" Inherits="util_pop_companypicker" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Settlement Attorney Picker</title>
</head>
                ...
                <tr>
                    <td style="padding-top: 15; padding-left: 15; height: 100%;" valign="top">
                        <table border="0" cellpadding="0" cellspacing="7" style="font-family: tahoma; font-size: 11px;">
                            <tr>
                                <td>
                                    Select settlement attornies to associate with this user account.
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div style="overflow: auto; height: 175px">
                                        <asp:CheckBoxList ID="cblCompanys" runat="server">
                                        </asp:CheckBoxList>
                                    </div>
                                </td>
                            </tr>
