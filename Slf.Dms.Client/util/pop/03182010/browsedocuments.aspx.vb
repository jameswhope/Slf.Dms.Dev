...
#End Region
    ...
    Private Sub FillDocumentTree()
        ...
        iParentFolder = 1
        If Directory.Exists(DocumentRoot + "\CreditorDocs\" + strCreditorFolder) Then
            Dim rootFolder As New DirectoryInfo(DocumentRoot + "\CreditorDocs\" + strCreditorFolder)
    ...
    Private Function AddNodeAndDescendents(ByVal folder As DirectoryInfo, ByVal parentNode As TreeNode, ByVal indent As Integer, ByVal level As Integer) As TreeNode
        ...
        If parentNode Is Nothing Then
            virtualFolderPath = DocumentRoot + "\CreditorDocs\" + strCreditorFolder
        Else
