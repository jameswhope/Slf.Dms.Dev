...
Partial Class util_pop_attachnewmatterdocument
    ...
    Private Function AddNodeAndDescendents(ByVal folder As DirectoryInfo, ByVal parentNode As TreeNode, ByVal indent As Integer, ByVal level As Integer) As TreeNode
        ...
        If Not (strFolderName.ToLower().Equals("legaldocs") Or level = 1) Then 'legacydocs
            For Each subFile As FileInfo In fileList
                ...
                tempFile = New TreeNode("<table style=""width:100%;border-bottom:solid 1px #d1d1d1;"" onclick=""javascript:OnFileClick(0,'" + tempName.Replace("/", "//") + "','" & tempDoc.DocumentName.Replace("'", "\'") & "','" & tempDoc.Received & "','" & tempDoc.Created & "','" & tempDoc.CreatedBy & "');""><tr style=""width:100%;font-family:tahoma;font-size:11px;""><td style=""width:280px;"" align=""left"">" + DuplicateStr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", indent + 1) + "<img src=""" + ResolveUrl("~/images/16x16_file_new.png") + """ border=""0"" alt="""" />&nbsp;" + tempDoc.DocumentName + "</td><td style=""width:130px;"" align=""left"">" + tempDoc.Received + "</td><td style=""width:130px;"" align=""left"">" + tempDoc.Created + "</td><td align=""left"">" + tempDoc.CreatedBy + "</td></tr></table>")
                ' tempFile = New TreeNode("<table style=""width:100%;border-bottom:solid 1px #d1d1d1;"" onclick=""javascript:OnFileClick('" + tempName.Replace("/", "//") + "','" & tempDoc.DocumentName.Replace("'", "\'") & "','" & tempDoc.Received & "','" & tempDoc.Created & "','" & tempDoc.CreatedBy & "');""><tr style=""width:100%;font-family:tahoma;font-size:11px;""><td style=""width:280px;"" align=""left"">" + DuplicateStr("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", indent + 1) + "<img src=""" + ResolveUrl("~/images/16x16_file_new.png") + """ border=""0"" alt="""" />&nbsp;" + tempDoc.DocumentName + "</td><td style=""width:130px;"" align=""left"">" + tempDoc.Received + "</td><td style=""width:130px;"" align=""left"">" + tempDoc.Created + "</td><td align=""left"">" + tempDoc.CreatedBy + "</td></tr></table>")
