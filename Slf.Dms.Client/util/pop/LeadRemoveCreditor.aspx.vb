...
Partial Class util_pop_LeadRemoveCreditor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            Me.lblMessage.Text = "Why is this creditor is being deleted."
        ...
        If Not Saved Then
            If Reason <> "" Then
                If Reason = "Other" Then
                    ...
                    Else
                        Alert.Show("Please enter a reason why this creditor is being deleted.")
                        Exit Sub
                    End If
                End If
