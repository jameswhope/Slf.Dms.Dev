<%@ Page Language="VB" AutoEventWireup="false" CodeFile="void.aspx.vb" Inherits="util_pop_void" %>
            ...
            <tr>
                <td style="height:40px;border-top:solid 2px rgb(149,180,234);padding-left:10px;padding-right:10px;">
                    <table style="height:100%;font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td><a tabindex="1" style="color:black" class="lnk" href="javascript:window.close();"><img style="margin-right:6px;" runat="server" src="~/images/16x16_back.png" border="0" align="absmiddle" />Cancel and Close</a></td>
                            <td align="right"><a runat="server" id="lnkVoid" tabindex="2" style="color:black" class="lnk" href="#" onclick="javascript:VoidRecords();"></a></td>
                        </tr>
                    </table>
                </td>
            </tr>
