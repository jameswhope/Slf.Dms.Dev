...
Partial Class util_pop_attachglobaldoc
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        ...
        Dim filePath As String = BuildAttachmentPath(value, docId, Now.ToString("yyMMdd"), clientid)
        ...
        If FileUpload1.HasFile Then
            ...
            Try
                ...
                DatabaseHelper.AddParameter(cmd, "RelationID", clientid)
                DatabaseHelper.AddParameter(cmd, "RelationType", "client")
