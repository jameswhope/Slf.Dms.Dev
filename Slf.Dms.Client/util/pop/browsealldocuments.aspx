<%@ Page Language="VB" AutoEventWireup="false" CodeFile="browsealldocuments.aspx.vb"
    Inherits="util_pop_browsealldocuments" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function OnFileClick(name, text) {
            return false;
            window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachments").value = window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachments").value + name + ";"
            window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachmentstext").value = window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachmentstext").value + text + ";"
            self.close();
        ...
        function AttachSelected() {
            ...
            window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachments").value = name
            window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachmentstext").value = text  
...
<body style="background-image: url(<%= ResolveUrl("~/images/back.bmp") %>); background-position: left top;
    ...
    <script>
        window.onload = function() {
            var selecteditems = window.opener.document.getElementById("ctl00_ctl00_ctl00_cphBody_cphBody_cphBody_txtAttachments").value
           //alert('ok'+selecteditems)
            ...
            for (var i = 0; i < formcontrols.length; i++) {
                if (formcontrols[i].type == "checkbox") {
                    if (formcontrols[i].getAttribute("value") != "on") {
                        ...
                        //alert(pdffilename)
                        pdffilename = pdffilename.substring(0, pdffilename.lastIndexOf("$"))//.replace("$", "")
                       // alert(pdffilename)
