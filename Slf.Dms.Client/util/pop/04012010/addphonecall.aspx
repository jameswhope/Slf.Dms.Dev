<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addphonecall.aspx.vb" Inherits="util_pop_addphonecall" %>
<%@ Register Assembly="AssistedSolutions.WebControls.InputMask" Namespace="AssistedSolutions.WebControls" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Add Matter Phone Call</title>
    <base target="_self" />
	...
	{
        showModalDialog("<%= ResolveUrl("~/deleteholder.aspx?t=Phone Call&p=phonecall") %>", window, "status:off;help:off;dialogWidth:400px;dialogHeight:300px;");
	}
                ...
                <td valign="top">
                    <table style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="width:50%;" valign="top">
                                <table style="font-family:tahoma;font-size:11px;width: 100%;" border="0" cellpadding="5" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" onclick="AddressBook();return false;"><img id="Img5" runat="server" src="~/images/16x16_addressbook.png" border="0" align="absmiddle" /></a></td>
                                    </tr>
                                    <tr>
                            ...
                            <td><img id="Img6" height="1" width="30" runat="server" src="~/images/spacer.gif" /></td>
                            <td style="width:50%;" valign="top">
                                <table style="font-family: tahoma; font-size: 11px; width: 100%;" border="0" cellpadding="5"
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap="true">
                                            <cc1:InputMask cssclass="entry" ID="txtStarted" runat="server" Mask="nn/nn/nnnn nn:nn:nn aa"  Width="150px" ></cc1:InputMask>&nbsp;&nbsp;<a id="aStartedNow" class="lnk" href="javascript:SetToNow('txtStarted')">Set to Now</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:50;">
                                        ...
                                        <td nowrap="true">
                                            <cc1:InputMask cssclass="entry" ID="txtEnded" runat="server" Mask="nn/nn/nnnn nn:nn:nn aa" Width="150px"></cc1:InputMask>&nbsp;&nbsp;<a id="aEndedNow" class="lnk" href="javascript:SetToNow('txtEnded')">Set to Now</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="5" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <table style="font-family:tahoma;font-size:11px;width:100%;" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td class="entrytitlecell" style="width:15;">Subject:</td>
                                                    <td align="left"><asp:TextBox CssClass="entry" runat="server" Width="400px" id="txtSubject"></asp:TextBox></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><asp:textbox cssclass="entry" runat="server" id="txtMessage" rows="7" TextMode="MultiLine" MaxLength="1000" columns="50" style="width:100%;"></asp:textbox></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
