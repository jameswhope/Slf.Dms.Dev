<%@ WebHandler Language="VB" Class="getchildfunctions_usertype" %>
...
Public Class getchildfunctions_usertype : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim UserTypeId As Integer = Integer.Parse(context.Request.QueryString("UserTypeId"))
        ...
        Using cmd As IDbCommand = ConnectionFactory.CreateCommand("stp_Permissions_UserTypeFunctionFunctions_Get")
