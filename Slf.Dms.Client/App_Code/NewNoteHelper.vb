...
Public Class NewNoteHelper

    Public Function AppendNote(ByVal noteId As Integer, ByVal value As String, ByVal userId As Integer) As Integer
    ...
    Public Function UpdateNote(ByVal noteId As Integer, ByVal value As String, ByVal userId As Integer) As Integer
    ...
    Public Sub RelateNote(ByVal NoteID As Integer, ByVal RelationTypeID As Integer, ByVal RelationID As Integer)
    ...
    Public Function InsertNote(ByVal Value As String, ByVal UserID As Integer, ByVal ClientID As Integer) As Integer
    ...
    Public Function GetNote(ByVal NoteID As String) As String
