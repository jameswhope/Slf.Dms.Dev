...
Public Class FitzCamp_0001 : Inherits SettlementCalculator
...
#Region "Methods"
    ...
    Public Overrides Function GetSettlementData() As DataTable
        ...
        Return SqlHelper.GetDataTable("stp_GetApplicantsSettlementFees_FitzCampbell0001", CommandType.StoredProcedure, params.ToArray)
    End Function
