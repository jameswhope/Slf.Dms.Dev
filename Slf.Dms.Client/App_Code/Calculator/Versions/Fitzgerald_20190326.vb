...
Public Class Fitzgerald_20190326 : Inherits SettlementCalculator

#Region "Fields"
    Dim _SettlementPercentages() As Double
    Dim _FixedFeePercentage As Double
    Dim _SettlementPercentage As Double
    Dim _ContingencyFees As Double
...
#Region "Methods"
    ...
    Public Overrides Function Calculate() As List(Of Results)
        ...
        For Each dr As DataRow In dtSettlementFees.Rows
            ...
            _SettlementPercentage = CDbl(dr("SettlementFees").ToString)
        ...
        For Each Deposit As Double In Deposits
            ...
            For Each Percent As Double In _SettlementPercentages
                ...
                _Results.ContingencyFees = _ContingencyFees.ToString("0.00")
    ...
    Public Overrides Function GetSettlementData() As DataTable
        ...
        Return SqlHelper.GetDataTable("stp_GetApplicantsSettlementFees_Fitzgerald20190326", CommandType.StoredProcedure, params.ToArray)
    End Function
