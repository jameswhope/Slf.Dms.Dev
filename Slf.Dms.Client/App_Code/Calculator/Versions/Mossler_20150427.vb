...
Public Class Mossler_20150427 : Inherits SettlementCalculator

#Region "Fields"

    Dim _SettlementPercentages() As Double
    Dim _FixedFeeAmount As Double
...
#Region "Methods"
    ...
    Public Overrides Function Calculate() As List(Of Results)
        ...
        For Each dr As DataRow In dtSettlementFees.Rows
            _FixedFeeAmount = CDbl(dr("FixedFeeAmount").ToString)
        ...
        For Each Deposit As Double In Deposits
            ...
            For Each Percent As Double In _SettlementPercentages
                ...
                _SettlementFees = _Applicant.TotalDebt * _FixedFeeAmount
                ...
                _Results.SettlementFeePercentage = "0.00"
    ...
    Public Overrides Function GetSettlementData() As DataTable
        ...
        Return SqlHelper.GetDataTable("stp_GetApplicantsSettlementFees_Mossler_20150427x", CommandType.StoredProcedure, params.ToArray)
    End Function
