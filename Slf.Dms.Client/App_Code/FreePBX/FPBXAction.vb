...
Public MustInherit Class FPBXAction

    Public MustOverride Function Execute(ByVal json As String) As String

    Public Shared Function Create(ByVal action As String) As FPBXAction
        Dim classname As String = String.Format("FPBX{0}Action", action.Trim)
