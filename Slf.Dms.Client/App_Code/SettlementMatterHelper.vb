...
#End Region
    ...
    Private Shared Function GetStipulationEmailBody(ByVal ClientId As Integer) As String
        ...
        If LanguageId = 2 Then
            sb.Append("Se adjunta la estipulación de acuerdo con su acreedor que debe ser firmada. ")
            ...
            sb.Append("Por favor tenga en cuenta que la solución no se pagará hasta una copia firmada es recibida en nuestra oficina.")
        Else
