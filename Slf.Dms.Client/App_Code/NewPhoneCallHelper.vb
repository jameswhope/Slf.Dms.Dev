...
Public Class NewPhoneCallHelper

    Public Sub RelatePhoneCall(ByVal PhoneCallID As Integer, ByVal RelationTypeID As Integer, ByVal RelationID As Integer)
    ...
    Public Function UpdatePhoneCall(ByVal phoneCallId As Integer, ByVal UserID As Integer, ByVal InternalUserID As String, ByVal PersonID As Integer, ByVal Direction As Integer, ByVal PhoneNumber As String, ByVal Body As String, ByVal Subject As String, ByVal StartTime As DateTime, ByVal EndTime As DateTime, Optional ByVal Reasons As String = "") As Integer

        If Reasons = Nothing Then Reasons = ""
        ...
        Using cmd As IDbCommand = ConnectionFactory.Create().CreateCommand()
            Using cmd.Connection
                ...
                DatabaseHelper.AddParameter(cmd, "Reasons", Reasons)
    ...
    Public Function InsertPhoneCall(ByVal ClientID As Integer, ByVal UserID As Integer, ByVal InternalUserID As String, _
        ...
        ByVal EndTime As DateTime, Optional ByVal Reasons As String = "") As Integer
    ...
    Public Function TruncateMessage(ByVal value As String) As String
        Return TruncateMessage(value, 150)
    End Function

    Public Function TruncateMessage(ByVal value As String, ByVal length As Integer) As String
    ...
    Public Function RegisterInboundCall(ByVal clientId As Integer, ByVal userId As Integer, ByVal callId As Long) As Long
        Dim cmd As IDbCommand = ConnectionFactory.Create().CreateCommand()
