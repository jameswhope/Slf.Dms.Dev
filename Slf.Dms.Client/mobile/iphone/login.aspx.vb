...
Partial Class mobile_iphone_login
    Inherits System.Web.UI.Page ' System.Web.UI.MobileControls.MobilePage
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        DatabaseHelper.AddParameter(cmd, "UserName", txtUsername.Value)
        DatabaseHelper.AddParameter(cmd, "Password", DataHelper.GenerateSHAHash(txtPassword.Value))
                ...
                Else
                    If Not Temporary Then
                        If Drg.Util.DataHelpers.SettlementProcessingHelper.IsManager(UserID) Then
                            ...
                            'Response.Redirect("iui/default.aspx")
