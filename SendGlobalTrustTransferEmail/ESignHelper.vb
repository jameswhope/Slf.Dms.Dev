                            ...
                            If obj.IsIndirect() Then
                                ...
                                If PdfName.IMAGE.Equals(type) Then
                                    ...
                                    Select Case bHasCoapps
                                        Case True
                                            If pdf.NumberOfPages > 8 AndAlso SigCountInDoc = 1 Then
                                                SigCountInDoc += 1
                                            End If
                ...
                Try
                    ...
                    If (obj.IsIndirect) Then
                        ...
                        If pdf.PdfName.IMAGE.Equals(subtype) Then
                            ...
                            'Comment out by Chuck Temporary If breaks uncomment ' 9/15/2014
...
#Region "Methods"
        ...
        Public Shared Sub SaveLexxSignDocument(ByVal DataClientID As Integer, ByVal documentID As String, ByVal submittedBy As Integer, ByVal docTypeID As String, ByVal SigningBatchID As String, ByVal signatoryEmail As String, ByVal relationTypeID As Integer, ByVal relationID As Integer)
            ...
            params.Add(New SqlParameter("DocumentId", documentID))
            params.Add(New SqlParameter("DocumentTypeID", docTypeID))
            params.Add(New SqlParameter("SigningBatchID", SigningBatchID))
            params.Add(New SqlParameter("SubmittedBy", submittedBy))
            params.Add(New SqlParameter("RelationTypeID", relationTypeID))
            params.Add(New SqlParameter("RelationID", relationID))

            Select Case docTypeID
                Case "D2006"
                    params.Add(New SqlParameter("Completed", Now))
                    params.Add(New SqlParameter("CurrentStatus", "Complete"))
                    params.Add(New SqlParameter("SignatoryEmail", signatoryEmail))
                Case Else
                    params.Add(New SqlParameter("SignatoryEmail", signatoryEmail))
                    params.Add(New SqlParameter("CurrentStatus", "Waiting on signatures"))
            End Select

            SqlHelper.ExecuteNonQuery("stp_lexxsign_insertdocument", CommandType.StoredProcedure, params.ToArray)
        ...
        '    msgBody.AppendFormat("<tr><td style='background-color: #326FA2; padding-top:30px' align='right'><img src='http://service.lexxiom.com/80/public/images/poweredby.png' /></td></tr>")
