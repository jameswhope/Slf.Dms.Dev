CREATE DATABASE [WA] ON  PRIMARY 
( NAME = N'WA', FILENAME = N'E:\Microsoft SQL Server\MSSQL.1\MSSQL\Data\WA.mdf' , SIZE = 21504KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'WA_log', FILENAME = N'F:\Microsoft SQL Server\MSSQL.1\MSSQL\Data\WA_log.ldf' , SIZE = 15360KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
END

GO
EXEC dbo.sp_dbcmptlevel @dbname=N'WA', @new_cmptlevel=90
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [WA].[dbo].[sp_fulltext_database] @action = 'disable'
end
GO
ALTER DATABASE [WA] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [WA] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [WA] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [WA] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [WA] SET ARITHABORT OFF 
GO
ALTER DATABASE [WA] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [WA] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [WA] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [WA] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [WA] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [WA] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [WA] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [WA] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [WA] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [WA] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [WA] SET  ENABLE_BROKER 
GO
ALTER DATABASE [WA] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [WA] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [WA] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [WA] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [WA] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [WA] SET  READ_WRITE 
GO
ALTER DATABASE [WA] SET RECOVERY FULL 
GO
ALTER DATABASE [WA] SET  MULTI_USER 
GO
ALTER DATABASE [WA] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [WA] SET DB_CHAINING OFF 

USE [WA]
GO
/****** Object:  User [dms_sql2]    Script Date: 10/08/2010 15:49:31 ******/
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'dms_sql2')
CREATE USER [dms_sql2] FOR LOGIN [dms_sql2] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  Table [dbo].[tblEMSDailyTransactionJournal]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblEMSMonthlyBalances]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblM2M_PREDAYDetail]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblM2M_CURDAYDetail]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNACHA_CCDReject_03-04]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNACHA_PPDStatistics_02]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNACHA_PPDReject_03-04]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblICLRECFileHeader_05]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblICLRECFileDetail_06]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblICLRECDetailAddendum_07]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblICLRECFileControl_09]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblICLACKCashLetterHeader_10]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblICLACKItemAdjustmentDetail_25]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblICLACKItemDetailAddendum_26]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblICLACKCashLetterControl_90]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblICLACKFileControl_99]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblICLACKFileHeader_01]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  StoredProcedure [dbo].[stp_PopulateM2MTables]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblBAFFConfirmation_C29]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblBAFFConfirmation_C20]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNACHA_CCDStatus_01]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNACHA_PPDStatus_01]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNACHA_CCDStatistics_02]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblNOC1]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblNOC5]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblNOC7]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblNOC8]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblNOC9]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblNOC6]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tblBAICodes]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblM2M_CURDAYSummary]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblM2M_PREDAYSummary]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[get_IsBankHoliday]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Table [dbo].[tblBAFFRejectReason]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[stp_NOC_Returns]    Script Date: 10/08/2010 15:49:31 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
