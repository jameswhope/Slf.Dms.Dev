 IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'stp_AgencyIncomeComparison_NonInitialDrafts')
	BEGIN
		DROP  Procedure  stp_AgencyIncomeComparison_NonInitialDrafts
	END
