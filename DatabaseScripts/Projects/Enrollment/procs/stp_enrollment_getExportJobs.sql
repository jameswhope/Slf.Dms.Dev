IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'stp_enrollment_getExportJobs')
	BEGIN
		DROP  Procedure  stp_enrollment_getExportJobs
	END

GO

CREATE Procedure stp_enrollment_getExportJobs
AS
