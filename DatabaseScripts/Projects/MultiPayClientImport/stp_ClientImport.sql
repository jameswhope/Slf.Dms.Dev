...
GO
/****** Object:  StoredProcedure [dbo].[stp_ClientImport]    Script Date: 05/01/2009 15:47:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE Procedure stp_ClientImport
(
	@companyid int,
	@agencyid int,
	@dbname nvarchar(100)
...
/*
	...
	04/30/2009 jhope             Redo layout for tables and change headers for tables
	05/07/2009 jhope             Redo Layout for tables with new header layout.
	06/01/2009 jhope             Validated and modified column count for no overrun.
*/
