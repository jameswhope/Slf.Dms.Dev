IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'stp_Dialer_GetNextClient4CIDNonDepositQueue')
	BEGIN
		DROP  Procedure  stp_Dialer_GetNextClient4CIDNonDepositQueue
	END

GO

CREATE Procedure stp_Dialer_GetNextClient4CIDNonDepositQueue
AS
Begin
