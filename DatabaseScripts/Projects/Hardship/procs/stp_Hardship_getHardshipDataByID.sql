IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'stp_Hardship_getHardshipDataByID')
	BEGIN
		DROP  Procedure  stp_Hardship_getHardshipDataByID
	END

GO

CREATE Procedure stp_Hardship_getHardshipDataByID
...
GRANT EXEC ON stp_Hardship_getHardshipDataByID TO PUBLIC
