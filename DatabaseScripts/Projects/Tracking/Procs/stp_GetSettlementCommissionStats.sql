IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'stp_GetSettlementCommissionStats')
	BEGIN
		DROP  Procedure  stp_GetSettlementCommissionStats
	END
...
GRANT EXEC ON stp_GetSettlementCommissionStats TO PUBLIC
