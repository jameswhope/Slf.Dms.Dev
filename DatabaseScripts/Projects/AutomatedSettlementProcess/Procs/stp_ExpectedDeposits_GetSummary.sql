IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'stp_ExpectedDeposits_GetSummary')
	BEGIN
		DROP  Procedure  stp_ExpectedDeposits_GetSummary
	END

GO

CREATE Procedure stp_ExpectedDeposits_GetSummary
(
	@clientid int,
	@enddate datetime
)
...
GRANT EXEC ON stp_ExpectedDeposits_GetSummary TO PUBLIC
