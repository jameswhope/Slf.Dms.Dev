/****** Object:  StoredProcedure [dbo].[stp_IssueCommBatch_S]    Script Date: 11/19/2007 15:27:23 ******/
DROP PROCEDURE [dbo].[stp_IssueCommBatch_S]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[stp_IssueCommBatch_S]
...
where
      commbatchid is null
      and tblcommstruct.commstructid < 56
...
from
      (
            ...
            from
                  ...
                  tblcommstruct on tblcommpay.commstructid = tblcommstruct.commstructid and tblcommstruct.commstructid < 56
            group by
                  tblcommstruct.commscenid,
                  tblcommstruct.commrecid,
                  tblcommstruct.parentcommrecid,
            ...
            from
                  ...
                  tblcommstruct on tblcommchargeback.commstructid = tblcommstruct.commstructid and tblcommstruct.commstructid < 56
            group by
                  tblcommstruct.commscenid,
                  tblcommstruct.commrecid,
                  tblcommstruct.parentcommrecid,
...
while @@fetch_status = 0
      begin
                        ...
                        if not @numparentcommrecs is null and @numparentcommrecs > 0
                              begin
                                    ...
                                    declare cursorComScensParentRecs cursor local for
                                          select distinct parentcommrecid from #tempGroup where commscenid = @commscenid and not parentcommrecid = 15
            ...
            exec stp_IssueCommBatchOut @commbatchid, @commscenid, '#tempGroup', 15
